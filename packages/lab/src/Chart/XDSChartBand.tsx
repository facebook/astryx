...
export interface XDSChartBandProps {
...
/**
 * Band mark between two y-values. Use for confidence intervals, error ranges,
 * or any min/max band around a line.
 *
 * @example
 * ```
 * <XDSChartBand yUpper="upper95" yLower="lower95" color={colors[0]} />
 * <XDSChartBand yUpper="upper95" baseline="mean" color={colors[0]} />
 * ```
 */
export function XDSChartBand({
  yUpper,
  yLower,
  baseline,
  color,
