...
/**
 * @file SVGIcon.test.tsx
 * @input Renders SVGIcon with starter icon defs across variations
 * @output Render-smoke coverage: aria-hidden svg output, theme reflection,
 *   fill/stroke role split, bold-mode mask knockouts, strokeWidth override,
 *   viewBox and prop passthrough (#4295)
 * @position Colocated test for SVGIcon.tsx
 */
...
import {calendarIcon, homeIcon, xIcon} from './icons';
...
describe('SVGIcon', () => {
  it('renders an aria-hidden svg containing the icon geometry', () => {
  ...
  it('reflects variation, size, and color as data attributes with the stable class', () => {
    ...
    const svg = container.querySelector('svg');
    expect(svg?.classList.contains('astryx-svg-icon')).toBe(true);
    // Defaults.
