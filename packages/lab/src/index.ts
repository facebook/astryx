...
export {
  ...
  XDSChartAxis as XDSChartV2Axis,
  type XDSChartAxisProps as XDSChartV2AxisProps,
  XDSChartGrid as XDSChartV2Grid,
  type XDSChartGridProps as XDSChartV2GridProps,
