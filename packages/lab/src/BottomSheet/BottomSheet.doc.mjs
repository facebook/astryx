...
export const docsDense = {
  ...
  usage: {
    description:
      'Mobile surface for filters, actions, forms, and detail views. Drag the handle to resize between snap points; flick down to dismiss, up to expand. Modal: focus trap + restore, and Escape dismisses so swipe has a keyboard equivalent. Focused form controls scroll above the visual-viewport keyboard; sheet travel or closing dismisses it. Content clears the home indicator via safe-area inset.',
    bestPractices: [
      {
        guidance: true,
        description:
