  ...
  params: [
    {
      ...
      description: 'isOpen, onDismiss, optional snapHeights (candidate detent heights in px), onSnap, and onDragProgress (0->1 as the drag nears dismissal, for scrim-fade affordances). Internal to BottomSheet, not exported from the lab entry point.',
      required: true,
    },
  ],
  returns: [
