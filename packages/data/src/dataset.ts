 ...
 * @output All entity data arrays and summary objects
 * @position Core data; single source of truth for all mock entities
 *
 * This is the canonical dataset. All entity data lives here.
 * Templates never define their own data — they pull from this module
 * via the createData() API.
 */
