 ...
 *   the accessible name, generic hover tooltip, click callback, decorative
...
describe('InputClearButton', () => {
  it('shows a generic Clear tooltip while keeping the contextual accessible name', async () => {
    ...
    expect(tooltip).toHaveTextContent(/^Clear$/);
