...
| FR2 | The inner content wrapper MUST be a real box observed with the viewport and MUST use max-content inline sizing only when inline scrolling is requested.                   | `spec:AST-025` FR5–FR6          | implemented                         |
