...
export const docs = {
  ...
  props: [
    ...
    {name: 'padding', type: 'SpacingStep', description: 'Content padding on every logical edge; publishes matching inset geometry.', default: '0'},
    {name: 'paddingInline', type: 'SpacingStep', description: 'Logical inline-axis content padding; overrides `padding` on that axis.'},
    {name: 'paddingInlineStart', type: 'SpacingStep', description: 'Logical inline-start content padding; overrides broader padding values.'},
    {name: 'paddingInlineEnd', type: 'SpacingStep', description: 'Logical inline-end content padding; overrides broader padding values.'},
    {name: 'paddingBlock', type: 'SpacingStep', description: 'Logical block-axis content padding; overrides `padding` on that axis.'},
    {name: 'paddingBlockStart', type: 'SpacingStep', description: 'Logical block-start content padding; overrides broader padding values.'},
    {name: 'paddingBlockEnd', type: 'SpacingStep', description: 'Logical block-end content padding; overrides broader padding values.'},
