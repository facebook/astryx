    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          name: 'hasSurface',
          type: 'boolean',
          description: 'Whether to apply the default popover surface (background, border-radius, box-shadow) to the content wrapper.',
          default: 'true',
        },
      ],
    },
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          name: 'hasSurface',
          type: 'boolean',
          description: '是否将默认弹出框表面样式（背景、圆角、阴影）应用到内容容器。',
          default: 'true',
        },
      ],
    },
  ...
  components: [
    ...
    },
    {
      ...
      propDescriptions: {
        ...
        hasSurface: 'Whether to apply default popover surface (background, radius, shadow) to content wrapper.',
      },
    },
  ],
};
