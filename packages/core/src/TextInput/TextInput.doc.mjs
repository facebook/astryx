...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      {guidance: false, description: 'Use placeholder text as a replacement for a label — placeholders disappear on focus and are not reliably read by screen readers.'},
      {guidance: false, description: 'Use TextInput for multi-line content like comments or descriptions — use TextArea instead.'},
      {guidance: false, description: 'Mark every field as required — only flag truly mandatory fields so users are not overwhelmed by validation errors.'},
    ],
    anatomy: [
