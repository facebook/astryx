...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      {guidance: false, description: 'Use tokens for primary actions or navigation — use Button or Link instead. Tokens are for displaying metadata, not triggering workflows.'},
      {guidance: false, description: 'Hide the label unless the icon alone is universally understood. A color dot without text is ambiguous.'},
      {guidance: false, description: 'Mix too many colors in one token group. Stick to two or three meaningful colors so the palette stays scannable.'},
    ],
    anatomy: [
...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      {guidance: false, description: 'Tokens for actions or navigation — use Button or Link. Tokens display metadata, not trigger workflows.'},
      {guidance: false, description: 'Hide the label unless the icon alone is universally clear.'},
      {guidance: false, description: 'Mix too many colors in one group. Two or three meaningful colors keeps it scannable.'},
    ],
  },
  propDescriptions: {
