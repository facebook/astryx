...
export const docs = {
  ...
  features: [
    ...
    'Status colors: info uses --color-primary-muted, warning uses --color-warning-muted, error uses --color-error-muted, success uses --color-success-muted',
...
export const docsZh = {
  ...
  features: [
    ...
    '状态颜色：info 使用 --color-primary-muted，warning 使用 --color-warning-muted，error 使用 --color-error-muted，success 使用 --color-success-muted',
