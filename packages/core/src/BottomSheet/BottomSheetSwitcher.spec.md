...
| Shared presentation | `hasScrim: true                                      | false`                                                                                | Selects the current modal scrim-backed host or non-modal no-scrim host         | Entire flow                            | `true`                                                                    | `component:BottomSheetSwitcher` | released                                                                                   | Boolean only |
