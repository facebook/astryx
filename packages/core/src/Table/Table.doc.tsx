...
export const docs: ComponentDoc = {
  name: 'Table',
  description:
    'A two-layer table system: XDSTable provides a styled, data-driven table with density, dividers, hover, and plugin support; XDSBaseTable provides the unstyled structural core with a composable plugin pipeline.',
  features: [
