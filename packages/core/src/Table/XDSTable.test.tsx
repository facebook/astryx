 ...
 *
 *
 * - /packages/cli/templates/showcase/Table.tsx (showcase preview)
 * - /packages/cli/templates/blocks/components/Table/TableAutogeneratedColumns.tsx (block template)
 * - /packages/cli/templates/blocks/components/Table/TableBasicDatadrivenTable.tsx (block template)
 * - /packages/cli/templates/blocks/components/Table/TableChildrenMode.tsx (block template)
 * - /packages/cli/templates/blocks/components/Table/TableColumnAlignmentAndVerticalAlignment.tsx (block template)
 * - /packages/cli/templates/blocks/components/Table/TableColumnResizePlugin.tsx (block template)
 * - /packages/cli/templates/blocks/components/Table/TableCustomPlugin.tsx (block template)
 * - /packages/cli/templates/blocks/components/Table/TableRichCellContentWithRenderCell.tsx (block template)
 * - /packages/cli/templates/blocks/components/Table/TableSelectionPlugin.tsx (block template)SYNC: When XDSBaseTable.tsx or XDSTable.tsx change, update tests to match new behavior
 */
