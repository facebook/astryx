...
export const docs = {
  ...
  theming: {
    targets: [
      ...
      {className: 'astryx-table-tree-chevron-icon', states: ['state']},
      {className: 'astryx-table-group-chevron-icon', states: ['state']},
      {className: 'astryx-table-expansion-chevron-icon', states: ['state']},
    ],
  },
