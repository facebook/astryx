...
When clicking a _different_ column in single-sort mode, the entire sort array is replaced with the new column ascending.
...
| `XDSTableHeaderCell` | `../XDSTableHeaderCell` | Not consumed directly — plugin transforms props passed _to_ it | —                                                               |
