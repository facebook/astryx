...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      {guidance: false, description: 'Display raw Unix timestamps or ISO strings to users \u2014 always pass them through Timestamp to get a human-readable format.'},
      {guidance: false, description: 'Use system_date or system_time formats in user-facing UI \u2014 they are for developer tools, logs, and machine-readable contexts.'},
      {guidance: false, description: 'Disable the tooltip on relative timestamps \u2014 users expect to hover for the full date when they see \u201c3 hours ago\u201d.'},
    ],
    anatomy: [
...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      {guidance: false, description: 'Raw Unix timestamps or ISO strings in the UI \u2014 always use Timestamp.'},
      {guidance: false, description: 'system_* formats in user-facing UI \u2014 those are for dev tools and logs.'},
      {guidance: false, description: 'Disable tooltip on relative timestamps \u2014 users expect the full date on hover.'},
    ],
  },
  propDescriptions: {
