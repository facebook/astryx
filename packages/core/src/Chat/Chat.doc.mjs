...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      { guidance: true, description: 'Set density on the message list to control spacing globally — compact for sidebars, balanced for full-page chats, spacious for long-form reading.' },
      { guidance: true, description: 'Use the group prop (first, middle, last) on consecutive bubbles from the same sender to create a continuous visual flow with tightened corners.' },
      ...
      { guidance: true, description: 'Use the group prop on bubbles (first/middle/last) when a sender sends multiple short messages in quick succession, so corner radii visually link them.' },
      ...
      { guidance: false, description: 'Don\'t wrap message list in a fixed-height div for scroll — use XDSChatLayout instead, which manages scroll containers, auto-scroll on new messages, and the scroll-to-bottom button.' },
...
export const docsDense = {
  ...
  usage: {
    description: 'Chat layout primitives + composer for AI chat UIs. Composer is a slot-based shell — drawer, headerActions, footerActions, sendActions. MessageList is scrollable msg container w/ density, a11y role="log", infinite scroll. Use Chat components for conversational UIs w/ message display, sender-aware styling, rich input.',
    bestPractices: [
      ...
      { guidance: true, description: 'Set density on the list — compact for sidebars, balanced for full-page, spacious for long-form.' },
      ...
      { guidance: true, description: 'Group prop (first/middle/last) on consecutive bubbles for continuous visual flow with tightened corners.' },
      ...
      { guidance: false, description: 'Fixed-height div wrapper for scroll — use XDSChatLayout instead.' },
    ],
  },
  components: [
    {
