...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      { guidance: false, description: 'Don\'t render raw XDSBadge to display composer tokens \u2014 use XDSChatComposerTokenElement instead. It adds the data-xds-token attributes needed for correct serialization.' },
      { guidance: false, description: 'Don\'t use XDSChatComposerTokenElement inside XDSChatComposerInput \u2014 the input manages its own token rendering via the trigger system and useXDSChatComposerTokens hook.' },
...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      { guidance: true, description: 'XDSChatComposerTokenElement for tokens outside contentEditable. Badge config for simple cases, custom render for rich content.' },
      { guidance: false, description: 'Custom contenteditable for mentions/commands \u2014 XDSChatComposerInput handles it.' },
      { guidance: false, description: 'Raw XDSBadge for composer tokens \u2014 TokenElement adds data-xds-token attrs for serialization.' },
      { guidance: false, description: 'TokenElement inside ComposerInput \u2014 input manages tokens via trigger system.' },
