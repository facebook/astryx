...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      { guidance: false, description: "Use type='detail' or type='caption' \u2014 these don't exist. For secondary descriptive text, use type='supporting'. For small labels, use type='label'." },
      { guidance: false, description: "Use color='success', color='error', or color='warning' \u2014 these are Icon/Badge colors, not Text colors. Valid Text colors: primary, secondary, disabled, placeholder, active, inherit." },
...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      { guidance: false, description: "type='detail'/'caption' \u2014 don't exist. Use 'supporting' for secondary text, 'label' for small labels." },
      { guidance: false, description: "color='success'/'error'/'warning' \u2014 Icon/Badge only. Text colors: primary, secondary, disabled, placeholder, active, inherit." },
