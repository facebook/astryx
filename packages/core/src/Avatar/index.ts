 ...
 * @output Exports Avatar, AvatarProps, AvatarSize, AvatarShape, resolveSize, shapeStyles, AvatarStatusDot, AvatarStatusDotProps, AvatarStatusDotVariant
...
export {Avatar, resolveSize, shapeStyles} from './Avatar';
