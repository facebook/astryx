 ...
 * the pressed overlay off those arms, and keep `:active` for a mouse. Every
 * Astryx component that paints a press already does this; reach for it when
 * a local component paints its own press and must behave like the rest of
 * the system under a finger.
 *
