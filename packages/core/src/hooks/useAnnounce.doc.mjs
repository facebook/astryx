...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      { guidance: true, description: 'Reach for this instead of hand-rolling an aria-live div; a region rendered with its content usually does not announce at all.' },
      { guidance: true, description: 'Keep "polite" for status and result counts; reserve "assertive" for errors and time-sensitive alerts, since it interrupts whatever the screen reader is saying.' },
      { guidance: true, description: 'Announce the outcome, not the interaction — "12 results" rather than "search ran".' },
      { guidance: false, description: 'Announce content that is already visible and correctly labeled in the DOM; that doubles up for screen reader users.' },
    ],
  },
...
export const docsDense = {
  ...
  returnDescriptions: {
    announce: 'speaks message through shared live region. politeness defaults "polite"; empty message clears lingering status.',
  },
  usage: {
    description:
    ...
    bestPractices: [
      { guidance: true, description: 'Use instead of hand-rolled aria-live div; region rendered w/ its content usually does not announce.' },
      { guidance: true, description: '"polite" for status / counts; "assertive" only for errors + time-sensitive alerts (it interrupts).' },
      { guidance: true, description: 'Announce outcome, not interaction — "12 results", not "search ran".' },
      { guidance: false, description: 'Announce content already visible + labeled in DOM; doubles up for AT users.' },
    ],
  },
};
