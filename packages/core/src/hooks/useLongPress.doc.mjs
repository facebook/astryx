...
export const docs = {
  ...
  params: [
    ...
    },
    {
      ...
      type: 'number',
      description: 'Movement past this distance on either axis cancels the press, treating it as a scroll or drag.',
      default: '10',
    },
  ],
  returns: [
  ...
  usage: {
    ...
    bestPractices: [
      { guidance: true, description: 'Use the reported point to position the surface you open, so it appears under the finger.' },
      { guidance: true, description: 'Pair it with the pointer contextmenu handler rather than replacing it — this hook only covers touch.' },
      { guidance: false, description: 'Use it for the primary action of a control; press-and-hold is undiscoverable as the only way to do something.' },
    ],
  },
...
export const docsDense = {
  ...
  paramDescriptions: {
    ...
    'options.moveCancelPx': 'movement past this (px, either axis) cancels as scroll / drag.',
  },
  returnDescriptions: {
    handlers: 'onTouchStart / onTouchMove / onTouchEnd / onTouchCancel to spread onto the element.',
  },
  usage: {
    description:
    ...
    bestPractices: [
      { guidance: true, description: 'Position the opened surface at the reported point.' },
      { guidance: true, description: 'Pair w/ pointer contextmenu handler; this covers touch only.' },
      { guidance: false, description: 'Make press-and-hold the only way to reach an action; it is undiscoverable.' },
    ],
  },
};
