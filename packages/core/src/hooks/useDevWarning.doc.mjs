...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      { guidance: true, description: 'Say what is wrong and what the builder should do instead — the message is the whole value of the warning.' },
      { guidance: true, description: 'Warn about combinations the types cannot express, such as two mutually exclusive props being set together.' },
      { guidance: false, description: 'Use it for anything a user could see or for runtime error handling; it is stripped from production builds.' },
    ],
  },
  relatedComponents: [],
  relatedHooks: [],
...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      { guidance: true, description: 'Say what is wrong + what to do instead; the message is the value.' },
      { guidance: true, description: 'Warn about combinations types cannot express (mutually exclusive props set together).' },
      { guidance: false, description: 'Use for user-visible problems / runtime error handling; it is dev-only.' },
    ],
  },
};
