 ...
 * - /packages/cli/templates/blocks/components/Dialog/DialogStaticPosition.tsx (block template)SYNC: When XDSDialogHeader.tsx changes, update tests to match new behavior
 */
