...
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ------------------------- |
| FR1  | The horizontal frame defaults `--step-connector-gap` to `0px`, the `stepper` root explicitly inherits it, and each connector has the same use-site fallback for an unframed vertical Stepper. Consumer frame values reach the root while a theme can still override it there directly. | Reviewed defect (PR #5495)           | Settled                   |
