...
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ------------------------- |
| FR1  | `--step-connector-gap` falls back to `0px` where each connector consumes it, so values inherit from a horizontal frame while a theme can still override it directly on the `stepper` root.                                                            | Reviewed defect (PR #5495)           | Settled                   |
