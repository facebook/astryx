...
| `horizontalOptions.collapsedVariant` | `withLabelAndControls \| withLabel \| hiddenLabel` | Required within `horizontalOptions`; which visible label and navigation controls appear beneath the compact track                                                                          | Compact horizontal orientation; controls additionally require `onStepClick`                                   | `withLabelAndControls` when `horizontalOptions` is omitted | Caller              | stable    | TypeScript rejects unknown variants                                                                       |
