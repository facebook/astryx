  ...
  components: [
    {
      ...
      props: [
        ...
        {name: 'isIconOnly', type: 'boolean', description: 'When true, renders as a square icon-only button with label as aria-label and an automatic tooltip.', default: 'false'},
  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        isIconOnly: '为 true 时渲染为方形仅图标按钮，label 作为 aria-label 并自动显示提示。',
  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        isIconOnly: 'square icon-only btn w/ aria-label + auto tooltip',
