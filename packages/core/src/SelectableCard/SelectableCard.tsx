 ...
 * - /packages/core/templates/blocks/components/Card/SelectableCardShowcase.tsx (showcase block)
 * - /packages/core/templates/blocks/components/Card/SelectableCardMulti.tsx (block)
 *
