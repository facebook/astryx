  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        toast: 'toast viewport config: position, maxVisible, inset, renderToast',
      },
    },
  ],
};
