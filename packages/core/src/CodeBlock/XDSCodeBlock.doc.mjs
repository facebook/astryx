  ...
  components: [
    {
      ...
      props: [
        ...
        {name: 'width', type: "'fit-content' | '100%'", description: "Width of the code block. 'fit-content' (default) shrinks to longest line. '100%' fills parent width.", default: "'fit-content'"},
  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        size: '文字大小变体。',
        width: "代码块宽度。'fit-content'（默认）适应最长行宽度；'100%' 填满父容器宽度。",
  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        width: "fit-content (default) or 100% to fill parent",
