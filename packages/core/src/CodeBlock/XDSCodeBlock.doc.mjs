  ...
  components: [
    {
      ...
      props: [
        ...
        {name: 'container', type: "'card' | 'fill' | 'section'", description: "Container presentation style. 'card' (default): fit-content width with border and radius. 'fill': full parent width with border and radius. 'section': full parent width, no border or radius — for embedding inside cards or panels.", default: "'card'"},
  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        size: '文字大小变体。',
        container: "容器展示样式。'card'=适应内容宽度，带边框和圆角；'fill'=填满父容器宽度，带边框和圆角；'section'=填满父容器宽度，无边框和圆角——适用于嵌入卡片或面板。",
  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        container: "card=fit-content w/ border+radius; fill=100% w/ border+radius; section=100% no border/radius (embed in cards)",
