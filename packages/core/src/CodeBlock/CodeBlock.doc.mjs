  ...
  components: [
    {
      ...
      props: [
        ...
        {name: 'container', type: "'card' | 'section'", description: "Container presentation style. 'card' (default): border and radius with the muted syntax background for a standalone card look. 'section': no border or radius and a transparent background so the block blends into the card or panel it's embedded in.", default: "'card'"},
  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        container: "card=border+radius+muted bg (default); section=no border/radius, transparent bg (embed in cards)",
