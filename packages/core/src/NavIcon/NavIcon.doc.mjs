...
export const docs = {
  ...
  features: [
    ...
    'Accent background — uses --color-accent with --color-icon-on-dark contrast',
...
export const docsZh = {
  ...
  features: [
    ...
    '强调色背景 — 使用 --color-accent 配合 --color-icon-on-dark 对比色',
...
export const docsDense = {
  ...
  features: [
    ...
    'Accent background; uses --color-accent w/ --color-icon-on-dark contrast',
