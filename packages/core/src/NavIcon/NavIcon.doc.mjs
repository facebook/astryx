...
export const docs = {
  ...
  features: [
    ...
    'Accent background — uses --color-primary with --color-icon-on-dark-media contrast',
...
export const docsZh = {
  ...
  features: [
    ...
    '强调色背景 — 使用 --color-primary 配合 --color-icon-on-dark-media 对比色',
...
export const docsDense = {
  ...
  features: [
    ...
    'Accent background; uses --color-primary w/ --color-icon-on-dark-media contrast',
