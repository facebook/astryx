  ...
  components: [
    {
      ...
      props: [
        ...
        {name: 'overflow', type: "'menu'", description: 'Collapse horizontal members that no longer fit into an overflow actions popover.', default: 'undefined'},
  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        overflow: '将不适合的水平成员折叠到溢出操作弹出窗口中。',
  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        overflow: 'collapse horizontal members into an overflow actions popover',
