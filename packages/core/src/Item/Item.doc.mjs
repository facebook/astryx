...
export const docs = {
  ...
  components: [
    {
      ...
      props: [
        ...
        {name: 'trailing', type: 'ReactNode', description: 'Trailing content — badges, metadata, timestamps, action buttons. Positioned to the right, flex-shrink: 0.', slotElements: [{__element: 'XDSBadge', props: {label: 3}}, {__element: 'XDSText', props: {color: 'secondary'}, children: '2h ago'}]},
  ...
  usage: {
    ...
    anatomy: [
      ...
      {name: 'Trailing', required: false, description: 'Right-aligned content — badges, timestamps, or action buttons.'},
    ],
  },
};
...
export const docsZh = {
  components: [
    {
      ...
      propDescriptions: {
        ...
        trailing: '尾部内容 — 徽章、元数据、时间戳、操作按钮。定位在右侧。',
  ...
  usage: {
    ...
    anatomy: [
      ...
      {name: '尾部', required: false, description: '右对齐内容 — 徽章、时间戳或操作按钮。'},
    ],
  },
};
  ...
  components: [
    {
      ...
      propDescriptions: {
        ...
        trailing: 'Right-aligned content — badges, timestamps, actions.',
