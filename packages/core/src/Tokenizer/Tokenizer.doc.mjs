...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      {guidance: false, description: 'Use Tokenizer for single-item selection \u2014 use Typeahead instead. Tokenizer is for building sets of two or more items.'},
      {guidance: false, description: 'Apply custom colors to individual tokens inside a Tokenizer \u2014 use the default token style for visual consistency across the set.'},
      {guidance: false, description: 'Hide the label \u2014 every Tokenizer needs a visible label so users understand what they are selecting. Use isLabelHidden only when surrounding context makes the purpose obvious.'},
    ],
    anatomy: [
...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      {guidance: false, description: 'Single-item selection \u2014 use Typeahead instead.'},
      {guidance: false, description: 'Custom token colors \u2014 default style for consistency.'},
      {guidance: false, description: 'Hidden label unless context makes purpose obvious.'},
    ],
  },
  propDescriptions: {
