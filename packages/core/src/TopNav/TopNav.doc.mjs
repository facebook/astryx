...
/** @type {string} */
export const docsDense = `import{XDSTopNav}from'@xds/core/TopNav' //top nav bar w/ slot layout
C XDSTopNav //main nav bar container w/ slot-based layout
P heading:ReactNode heading slot (logo, brand) at left edge | startContent:ReactNode nav items/breadcrumbs after heading, left-aligned | centerContent:ReactNode center slot (tabs, search); switches to 3-column CSS grid | endContent:ReactNode search/icons/profile at right edge | label:string a11y label for nav landmark, aria-label on <nav> | xstyle:StyleXStyles layout styles (margins, positioning); must be stylex.create() value
X <XDSTopNav\n  label="Main navigation"\n  heading={<XDSTopNavHeading heading="My App" href="/" />}\n  startContent={<XDSTopNavItem label="Dashboard" href="/dashboard" isSelected />}\n  endContent={<XDSButton label="Profile" variant="ghost" />}\n/> | <XDSTopNav\n  label="Main navigation"\n  heading={<XDSTopNavHeading heading="My App" href="/" />}\n  centerContent={<SearchInput placeholder="Search..." />}\n  endContent={<Avatar />}\n/>
C XDSTopNavHeading //heading w/ logo+text, optionally clickable link
P heading:string heading text | logo:ReactNode logo before heading text; image, XDSNavIcon, or ReactNode | href:string URL on click; renders as anchor
X <XDSTopNavHeading\n  heading="My App"\n  logo={<img src="/logo.svg" alt="" width={24} height={24} />}\n  href="/"\n/> | <XDSTopNavHeading\n  heading="Dashboard"\n  logo={<XDSNavIcon icon={<HomeIcon style={{width: 16, height: 16}} />} />}\n  href="/"\n/> | <XDSTopNavHeading logo={<BrandLogo />} href="/" />
C XDSTopNavItem //nav link w/ hover+selected states
P label:string! visible text or aria-label for icon-only items | href:string navigation URL | isSelected:boolean='false' sets aria-current="page"+highlighted styles | isDisabled:boolean='false' sets aria-disabled+tabIndex=-1 | icon:ReactNode icon before label; w/o children becomes icon-only | children:ReactNode custom content instead of label text | as:XDSLinkComponentType custom link component; overrides XDSLinkProvider default
X <>\n  <XDSTopNavItem label="Home" href="/" isSelected />\n  <XDSTopNavItem label="Products" href="/products" />\n  <XDSTopNavItem label="Settings" href="/settings" isDisabled />\n</> | <XDSTopNavItem\n  label="Settings"\n  href="/settings"\n  icon={<GearIcon style={{width: 16, height: 16}} />}\n/> | <XDSTopNavItem\n  label="Notifications"\n  href="/notifications"\n  icon={<BellIcon style={{width: 16, height: 16}} />}\n/>
C XDSTopNavMenu //hover-triggered popover menu w/ rich items
P label:string! trigger button label | items:XDSTopNavMenuItemData[]! menu items in hover popover | delay:number='150' show delay ms | hideDelay:number='200' hide delay ms
X <XDSTopNavMenu\n  label="Products"\n  items={[\n    {title: 'Analytics', description: 'View metrics', href: '/analytics'},\n    {title: 'Reports', description: 'Generate reports', href: '/reports'},\n  ]}\n/> | <XDSTopNavMenu\n  label="Tools"\n  items={[\n    {\n      title: 'Analytics',\n      description: 'Track and analyze user behavior',\n      icon: <ChartBarIcon />,\n      href: '/analytics',\n    },\n    {\n      title: 'Export',\n      description: 'Download your data',\n      icon: <ArrowDownTrayIcon />,\n      onClick: () => openExportDialog(),\n    },\n  ]}\n/>
C XDSTopNavMegaMenu //full-width mega menu panel on hover w/ 2-col grid+featured area
P label:string! trigger button label | items:XDSTopNavMegaMenuItemData[]! menu items in mega panel | featured:XDSTopNavMegaMenuFeatured optional featured content on right side | delay:number='150' show delay ms | hideDelay:number='250' hide delay ms | isSingleColumn:boolean='false' single-column layout instead of two | onOpenChange:(isOpen: boolean) => void fired on open/close; for coordinating wrapper styles
X <div style={{position: 'relative'}}>\n  <XDSTopNav\n    startContent={\n      <XDSTopNavMegaMenu\n        label="Solutions"\n        items={[\n          {title: 'Enterprise', description: 'For large teams', icon: <BuildingIcon />, href: '/enterprise'},\n          {title: 'Startups', description: 'Move fast', icon: <RocketIcon />, href: '/startups'},\n        ]}\n        featured={{\n          title: 'New: AI Features',\n          description: 'Explore our latest AI-powered tools.',\n          linkText: 'Learn more \u2192',\n          linkHref: '/ai',\n        }}\n      />\n    }\n  />\n</div> | <XDSTopNavMegaMenu\n  label="Products"\n  isSingleColumn\n  items={[\n    {title: 'Analytics', description: 'Track behavior', icon: <ChartIcon />, href: '/analytics'},\n    {title: 'Messaging', description: 'Real-time comms', icon: <ChatIcon />, href: '/messaging'},\n    {title: 'Storage', description: 'Manage your data', icon: <DatabaseIcon />, href: '/storage'},\n  ]}\n/>
X <XDSTopNav\n  label="Main navigation"\n  heading={\n    <XDSTopNavHeading\n      heading="My App"\n      logo={<XDSNavIcon icon={<HomeIcon style={{width: 16, height: 16}} />} />}\n      href="/"\n    />\n  }\n  startContent={\n    <>\n      <XDSTopNavItem label="Dashboard" href="/dashboard" isSelected />\n      <XDSTopNavItem label="Products" href="/products" />\n      <XDSTopNavItem label="Reports" href="/reports" />\n    </>\n  }\n  endContent={\n    <>\n      <XDSButton\n        label="Notifications"\n        variant="ghost"\n        icon={<BellIcon style={{width: 16, height: 16}} />}\n      />\n      <XDSButton\n        label="Profile"\n        variant="ghost"\n        icon={<UserCircleIcon style={{width: 16, height: 16}} />}\n      />\n    </>\n  }\n/> | <XDSTopNav\n  label="Main navigation"\n  heading={<XDSTopNavHeading heading="My App" href="/" />}\n  startContent={<XDSTopNavItem label="Home" href="/" isSelected />}\n  centerContent={<SearchBar />}\n  endContent={<Avatar />}\n/> | <XDSTopNav\n  label="Main navigation"\n  heading={<XDSTopNavHeading heading="My App" href="/" />}\n  startContent={\n    <>\n      <XDSTopNavItem label="Home" href="/" isSelected />\n      <XDSTopNavMenu\n        label="Products"\n        items={[\n          {title: 'Analytics', description: 'View metrics', href: '/analytics'},\n          {title: 'Reports', description: 'Generate reports', href: '/reports'},\n        ]}\n      />\n      <XDSTopNavMegaMenu\n        label="Solutions"\n        items={[\n          {title: 'Enterprise', description: 'For large teams', icon: <BuildingIcon />, href: '/enterprise'},\n          {title: 'Startups', description: 'Move fast', icon: <RocketIcon />, href: '/startups'},\n        ]}\n        featured={{\n          title: 'New: AI Features',\n          description: 'Explore our latest AI-powered tools.',\n          linkText: 'Learn more \u2192',\n          linkHref: '/ai',\n        }}\n      />\n    </>\n  }\n/> | <XDSLayout\n  header={\n    <XDSTopNav\n      label="Main navigation"\n      heading={<XDSTopNavHeading heading="My App" logo={<Logo />} href="/" />}\n      startContent={\n        <>\n          <XDSTopNavItem label="Home" href="/" isSelected />\n          <XDSTopNavItem label="Settings" href="/settings" />\n        </>\n      }\n      endContent={<Avatar />}\n    />\n  }\n  content={\n    <XDSLayoutContent role="main">\n      <MainContent />\n    </XDSLayoutContent>\n  }\n/>
A XDSTopNav renders <nav> w/ role="navigation"+aria-label from label prop|XDSTopNavItem sets aria-current="page" when isSelected|XDSTopNavItem sets aria-label for icon-only items|XDSTopNavItem sets aria-disabled+tabIndex=-1 when isDisabled|XDSTopNavMenu sets aria-haspopup="true" on trigger|XDSTopNavMegaMenu sets aria-haspopup="true"+aria-expanded on trigger|XDSTopNavMegaMenu items unreachable by keyboard (tabIndex=-1) when panel closed|Escape closes XDSTopNavMegaMenu panel
K Tab=navigate between items;Escape=close XDSTopNavMegaMenu panels
N Default height 48px (--spacing-12) w/ 16px horizontal padding|w/o centerContent: heading+startContent grow to push endContent right (flex)|w/ centerContent: CSS grid (1fr auto 1fr); right column always rendered for 3-col structure|positioning (sticky/fixed) handled by layout system (e.g. XDSAppShell), not TopNav|dividers controlled by layout system (e.g. XDSLayoutHeader hasDivider), not TopNav|XDSTopNavMegaMenu panels position relative to nearest positioned ancestor; wrap in position:relative container for full-width`;
