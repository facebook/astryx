...
export const docs = {
  ...
  theming: {
    targets: [
      ...
      {className: 'astryx-top-nav-heading-chevron-icon', states: ['state']},
      {className: 'astryx-top-nav-mega-menu', states: ['mode']},
      {className: 'astryx-top-nav-mega-menu-chevron-icon', states: ['state']},
      {className: 'astryx-top-nav-mega-menu-drawer-chevron-icon', states: ['state']},
      ...
      {className: 'astryx-top-nav-menu-chevron-icon', states: ['state']},
      {className: 'astryx-top-nav-menu-drawer-chevron-icon', states: ['state']},
    ],
  },
