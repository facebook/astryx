 ...
 * - /packages/cli/templates/blocks/components/TopNav/TopNavWithHoverMenuAndMegaMenu.tsx (block template)SYNC: When TopNav components change, update tests to match new behavior
 */
