...
__export(source_exports, {
  y2kIconRegistry: () => y2kIconRegistry,
  y2kPalettes: () => y2kPalettes,
  y2kTheme: () => y2kTheme
});
module.exports = __toCommonJS(source_exports);

// src/y2kTheme.ts
var import_theme = require("@xds/core/theme");
...
// src/y2kTheme.ts
var y2kSyntax = (0, import_theme.defineSyntaxTheme)({
  name: "xds-y2k",
  tokens: {
...
var y2kTheme = (0, import_theme.defineTheme)({
  name: "y2k",
  typography: {
