 ...
 * it was before, which keeps the default no---out flow — where the neighbour is
 * an uncompiled `icons.tsx` that only a bundler can resolve — working.
 */
...
describe('theme build --icons-specifier', () => {
  it('emits the declared specifier verbatim', async () => {
    ...
    expect(generated).toContain("from './icons.mjs'");
  ...
  it('accepts a specifier the generator could never have inferred', async () => {
    ...
    expect(generated).toContain("from '../build/registry/icons.js'");
  });
