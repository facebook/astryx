 ...
 * it goes to the terminal with control and format characters replaced — a
 * newline, an escape sequence, or a bidi override in `astryx.theme` must not
 * rewrite the operator's TTY. Every warn site in this file prints the
 * specifier through here.
 * @param {string} specifier
 */
function printable(specifier) {
  return specifier.replace(/[\p{Cc}\p{Cf}]/gu, '�');
}
