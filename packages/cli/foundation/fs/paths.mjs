 ...
 * @param {{exists: Map<string, boolean>, dirents: Map<string, import('node:fs').Dirent[]|null>}|null} [fsCache] - Optional memo from `createFsCache()`; callers resolving many names pass one to bound total filesystem work.
 * @returns {boolean}
 */
