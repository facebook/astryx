 ...
 */
function generatedHeader(sourceFile, lang = 'js') {
...
export function registerTheme(program) {
  ...
  theme
    ...
    .action(async (file, options) => {
      ...
      fs.writeFileSync(outPath, generatedHeader(sourceRelative, 'css') + css);
      ...
      fs.writeFileSync(jsPath, generatedHeader(sourceRelative, 'js') + generateBuiltModule(resolvedTheme || themeDef, iconInfo));
      fs.writeFileSync(dtsPath, generatedHeader(sourceRelative, 'ts') + generateBuiltTypes(themeDef, iconInfo));
      ...
      if (variantDecl) {
        ...
        fs.writeFileSync(variantDtsPath, generatedHeader(sourceRelative, 'ts') + variantDecl);
