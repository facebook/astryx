...
/**
 * Collect the custom (non-built-in) component prop values a theme declares in
 * its `components` keys, resolved to the core interface each one augments.
 * Reads known values from doc files to filter out base prop values.
 *
 ...
 * literal-union types (e.g. Button `size`, Heading `type`/`level`) have no
