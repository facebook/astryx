...
/**
 * Known Astryx component-override keys and their visual props.
 * Used to warn on typos in defineTheme component overrides.
 *
 * Mirrors the documented theming surface verbatim: one entry per
 * `theming.targets[].className` across the `*.doc.mjs` files in
 * packages/core/src (with the `astryx-` prefix stripped), each carrying that
 * target's `visualProps` list unchanged. The doc targets are themselves
 * guarded against the rendered `themeProps()`/`stableClassName()` literals,
 * so these keys are exactly the classes components render. Both directions
 * of drift — a key here without a doc target, and a doc target missing here
 * — are enforced by cli/commands/build-theme.registry.test.mjs, which also
 * compares each entry's props against the doc target's visualProps verbatim.
 * When core adds or changes a target, update the component doc first, then
 * copy the entry here.
 * @type {Record<string, string[]>}
 */
const KNOWN_COMPONENTS = {
  'alert-dialog': [],
  'app-shell': ['variant'],
  'app-shell-header': ['variant'],
  'app-shell-sidenav': ['variant'],
  'aspect-ratio': ['shape'],
  avatar: ['size'],
  'avatar-group': ['size'],
  'avatar-group-overflow': [],
  'avatar-status-dot': ['variant'],
  'avatar-status-dot-glyph': ['shape'],
  badge: ['variant'],
  banner: ['container', 'status'],
  'banner-content': ['container', 'status'],
  'banner-icon': ['status'],
  'base-table': [],
  blockquote: [],
  'breadcrumb-item': [],
  ...
  'chat-composer-drawer': ['collapsed'],
  'chat-composer-input': [],
  'chat-layout': ['density'],
  'chat-message': ['sender', 'density'],
  'chat-message-bubble': ['sender', 'variant', 'density'],
  'chat-message-list': ['density'],
  'chat-message-metadata': [],
  'chat-send-button': [],
  'chat-system-message': ['variant'],
  'chat-tokenized-text': [],
  'chat-tool-calls': [],
  checkbox: ['size'],
  'checkbox-input': ['size'],
  ...
  code: ['color'],
  codeblock: ['size', 'language', 'container'],
  collapsible: ['density'],
  'collapsible-content': ['density'],
  'collapsible-group': ['density'],
  'collapsible-trigger': ['density'],
  ...
  'date-range-input': ['size', 'status'],
  'date-range-input-clear-icon': [],
  'date-range-input-toggle-icon': [],
  'date-time-input': ['size', 'status'],
  'date-time-input-date-segment': ['size', 'status'],
  'date-time-input-time-segment': ['size', 'status'],
  dialog: ['variant'],
  divider: ['orientation', 'variant'],
  'dropdown-menu': [],
  'dropdown-menu-checkbox': ['size'],
  'dropdown-menu-item': ['size'],
  'dropdown-menu-radio': ['size'],
  'empty-state': ['variant'],
  field: ['layout'],
  'field-label': [],
  'field-status': ['type', 'variant'],
  'file-input': ['mode', 'status'],
  'form-layout': ['direction'],
  grid: ['align', 'columns', 'gap', 'justify'],
  'grid-span': [],
  heading: ['level', 'color'],
  hovercard: [],
  icon: ['color', 'size'],
  'input-group': ['size', 'status'],
  'input-group-text': [],
  item: ['density', 'align'],
  kbd: [],
  // `layer` has no doc theming target or rendered `astryx-layer` class —
  // kept for back-compat (see the registry test's allowlist).
  layer: [],
  layout: ['height'],
  'layout-content': [],
  'layout-footer': [],
  ...
  lightbox: [],
  link: ['color'],
  list: ['density', 'listStyle'],
  'list-item': [],
  markdown: ['density'],
  'metadata-list': ['columns', 'orientation'],
  'metadata-list-item': [],
  'mobile-nav': ['side'],
  'more-menu': [],
  'multi-selector': ['size', 'status'],
  'multi-selector-clear-icon': [],
  'multi-selector-indicator-icon': [],
  'nav-heading-menu': ['size'],
  'nav-heading-menu-item': ['size'],
  navicon: [],
  ...
  'overflow-list': [],
  overlay: [],
  'overlay-scrim': ['position'],
  pagination: ['size', 'variant'],
  'pagination-dot': ['size'],
  popover: [],
  'power-search': [],
  progressbar: ['variant'],
  'progressbar-fill': ['variant'],
  'progressbar-track': [],
  radio: ['size'],
  'radio-dot': ['size'],
  ...
  'segmented-control-item': ['size'],
  'selectable-card': ['selected', 'variant'],
  ...
  spinner: ['size', 'shade'],
  stack: ['direction', 'gap', 'wrap'],
  'stack-item': ['size'],
  statusdot: ['variant'],
  switch: ['size'],
  'switch-field': ['labelPosition', 'labelSpacing'],
  'switch-thumb': ['size'],
  tab: [],
  'tab-indicator': [],
  'tab-list': ['size'],
  ...
  textarea: ['size', 'status'],
  thumbnail: [],
  'time-input': ['size', 'status'],
  timestamp: ['type', 'color', 'format'],
  toast: ['type'],
  'toggle-button': [],
  'toggle-button-group': [],
  token: ['color', 'size'],
  tokenizer: ['size', 'status'],
  toolbar: [],
  tooltip: [],
  'top-nav': [],
  'top-nav-heading': [],
  ...
  'tree-list-chevron': [],
  'tree-list-guide': [],
  'tree-list-item': ['density'],
  'tree-list-item-label': [],
  'trigger-menu': [],
  typeahead: ['status', 'size'],
  'typeahead-dropdown': [],
  'typeahead-item': [],
};
  ...
  for (const [component, rules] of Object.entries(themeDef.components)) {
    ...
    for (const key of Object.keys(rules)) {
      ...
      for (const pair of pairs) {
        ...
        // pairs are validated against the registry's visual props.
        if (colonIdx === -1) continue;
        const prop = pair.slice(0, colonIdx);
