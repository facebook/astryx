 ...
 *
 * @param {Array<{version: string, codemods: Array<import('../../types/codemod.d.ts').CodemodEntry>}>} versionGroups
 ...
 * @param {import('../../types/codemod.d.ts').JscodeshiftFactory} options.jscodeshift
 * @param {boolean} [options.silent]
 * @returns {{totalFilesChanged: number, totalTransformsApplied: number, writtenFiles: string[], errors: Array<{file: string, codemod: string, error: string}>, skippedOptional: Array<import('../../types/codemod.d.ts').CodemodEntry>}}
 */
export function runIntegrationCodemods(
  ...
  const errors = [];
  /** @type {Array<import('../../types/codemod.d.ts').CodemodEntry>} */
