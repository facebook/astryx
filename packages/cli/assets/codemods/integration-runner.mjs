 ...
 *
 * @param {Array<{version: string, codemods: Array<import('../../authoring/codemod.d.ts').CodemodEntry>}>} versionGroups
 ...
 * @param {import('../../authoring/codemod.d.ts').JscodeshiftFactory} options.jscodeshift
 * @param {boolean} [options.silent]
 * @returns {{totalFilesChanged: number, totalTransformsApplied: number, writtenFiles: string[], errors: Array<{file: string, codemod: string, error: string}>, skippedOptional: Array<import('../../authoring/codemod.d.ts').CodemodEntry>}}
 */
export function runIntegrationCodemods(
  ...
  const errors = [];
  /** @type {Array<import('../../authoring/codemod.d.ts').CodemodEntry>} */
