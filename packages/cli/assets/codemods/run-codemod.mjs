 ...
 * @returns {import('../../types/codemod.d.ts').CliLog}
 */
 ...
 *
 * @param {import('../../types/codemod.d.ts').CodemodEntry} entry normalized codemod entry {id, codemod, package}
 * @param {{apply: boolean, log: import('../../types/codemod.d.ts').CliLog, jscodeshift: import('../../types/codemod.d.ts').JscodeshiftFactory}} ctx
 * @returns {import('../../types/codemod.d.ts').CodemodRunResult}
 */
