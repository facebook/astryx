...
describe('integration codemod discovery', () => {
  ...
  it('blocks an integration codemod from changing a generated file', async () => {
    scaffold({
      '0.2.0/drop-foo.mjs': `
        export default {
          type: 'code',
    ...
    fs.writeFileSync(
      generated,
      '/* Code generated by a theme compiler. DO NOT EDIT. */\n.foo {}\n',
    );
    ...
    expect(result.generatedFilesBlocked).toEqual(['src/theme.css']);
    ...
    expect(fs.readFileSync(generated, 'utf-8')).toContain('.foo {}');
  });
