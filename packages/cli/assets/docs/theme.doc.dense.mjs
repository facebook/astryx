...
export const docsDense = {
  ...
  sections: [
    ...
    { section: 'Building Themes for Production', title: 'Build for Production', content: [{ type: 'prose', text: 'astryx theme build compiles defineTheme to static CSS. outputs .css + .js (__built:true) + .d.ts.' }, null, null, null, { type: 'prose', text: 'theme with icons: generated .js imports the registry from a sibling path. theme build does NOT compile it; your build does (esbuild/tsup), and --icons-specifier ./icons.mjs points the import at the compiled file.' }, null, { type: 'prose', text: 'skip the compile step = build still exits 0. bundlers resolve ./icons to icons.tsx; Node fails with ERR_MODULE_NOT_FOUND.' }, null, null, null] },
