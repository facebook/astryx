...
export const docsDense = {
  ...
  sections: [
    ...
    { title: 'Component Overrides', content: [{ type: 'prose', text: 'components field targets stable component selectors. built CSS currently emits .xds-* compatibility selectors; rendered components also reflect visual props/states as data-* attrs (data-variant, data-size). write standard CSS (borderRadius, padding) — pipeline expands to internal vars. private vars (--_*) cannot be set — use CSS properties. run `npx xds component <Name>`.' }, null, null, null, null] },
