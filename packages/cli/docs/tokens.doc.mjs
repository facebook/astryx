...
All tokens defined in \`packages/core/src/theme/tokens.stylex.ts\`.
...
Component gap props use \`space0\`-\`space12\` mapping to these tokens.

## Size Tokens

Control heights for consistent sizing across buttons, inputs, selectors.
