...
| `doctor`                          | The health-check report: `checks` (each with id, label, status: pass \| warn \| fail \| info, a message, a fix when not passing, and optional structured integration `issues`) plus a `summary` of counts per status.                                                                                                                                                                                                                 |
