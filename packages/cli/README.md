...
| `init.remove`                     | The removal receipt — returned when --remove-agents is set: `data.removed` is true when a managed agent-docs block was found and removed, and false when there was none to remove.                                                                                                                                                                                                                                                         |
