...
| `docs.index`                      | One topic's section index: each section's key, title, and one-line summary.                                                                                                                                                                                                                   |
| `docs.detail`                     | One topic's full ReferenceDoc, with token-ref blocks inlined (--detail full).                                                                                                                                                                                                                 |
