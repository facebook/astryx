...
| `template.show`             | The resolved template's raw source plus its description, kind, and the Astryx components it composes (every listed name resolves through `astryx component <Name>`).                                                                 |
| `template.skeleton`         | A layout skeleton (structural tags with spatial annotations) plus the template's description and the Astryx components it composes (every listed name resolves through `astryx component <Name>`).                                   |
