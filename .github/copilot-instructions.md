...
- **Public, OSS repo.** Never introduce Meta-internal references into committed
  content — no internal task/diff/SEV IDs, internal hostnames, tooling
  fingerprints ("generated by …"), or internal URLs. Public GitHub `@handles`
  used for changeset contributor credit are fine.
