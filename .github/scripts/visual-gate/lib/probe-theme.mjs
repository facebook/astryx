...
//
// A theme that styles EVERY declared theming target, so the visual gate can
// prove each one still reaches the pixels. Not shipped; not published; a test
// fixture. Regenerate with: pnpm visual:probe-theme
//
// Coverage: ${coverage.targets} targets, ${coverage.selectors} selectors.
