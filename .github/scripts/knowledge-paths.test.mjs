...
describe('component knowledge paths', () => {
  it.each([
    [
      'nested Core component record',
      'packages/core/src/Button/Button.spec.md',
      'component',
    ],
    [
      'nested Lab public member record',
      'packages/lab/src/Future/FutureMember.spec.md',
      'component',
    ],
    [
      'nested Core module record',
    ...
    [
      ...
      'packages/richtext/src/RichTextEditor.spec.md',
      'component',
    ],
    [
