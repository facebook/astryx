...
| `design`              | Design rationale    | The _why_, trade-offs, principle→application                                                       | Fewer hard numbers than engineering |
...
- **Substance & purpose** — does the post have a clear reason to exist and deliver
  ...
  takeaways _earned_ to the profile's standard, not just asserted? Does
...
- **Information efficiency** — flag repetition (the same fact in intro + middle +
  conclusion is a _structural_ problem, name where it belongs), padding (the
  "sounds nice, deletes clean" sentence), and dead clichés (Orwell: cut every
  word you can). Judge information _per word_.
...
- **What actually sticks** — the one thing they take away. If it _differs_ from
