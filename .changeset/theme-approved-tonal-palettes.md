...
`defineTonalPalettes()` and `defineTheme({palettes})`. Numeric keys are HCT
tones from 0 (black) through 100 (white), and keep that direction in both light-
and dark-mode ramps. Palette metadata survives
