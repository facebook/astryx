# Form project (Formisch)

This project builds forms with **Formisch** on top of the Astryx design system,
using the Astryx bindings.

Read the adapter README for the full API before writing code:

```bash
cat node_modules/@astryxdesign/astryx-formisch/README.md
```

Formisch drives form state from a Valibot schema; the Astryx bindings render each
field with an Astryx component.
