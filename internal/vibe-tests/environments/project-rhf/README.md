# Form project (React Hook Form)

This project builds forms with **React Hook Form** on top of the Astryx design
system, using the Astryx bindings.

Read the adapter README for the full API before writing code:

```bash
cat node_modules/@astryxdesign/astryx-rhf/README.md
```

React Hook Form manages form state; the Astryx bindings render each field with an
Astryx component.
