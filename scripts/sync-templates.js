 ...
 *
 * Reads packages/core/templates/{name}/template.doc.mjs and generates:
...
const TEMPLATES_DIR = path.join(ROOT, 'packages', 'core', 'templates');
...
function generatePageRouteWrapper(template) {
  const depth = '../../../../../../../packages/core/templates/pages';
  return `${COPYRIGHT}/**
 * AUTO-GENERATED by scripts/sync-templates.js — do not edit.
