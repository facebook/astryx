import{aM as ha,ah as e,a1 as n,I as P,a7 as fa,e as va,af as ye,a6 as Sa,ay as ba}from"./iframe-Z8EfSKmM.js";import{F as Ta}from"./Field-BUd1jCAy.js";import{a as Re,b as Pe,i as Le,c as L}from"./inputStyles.stylex-Bpqcd25J.js";import{u as Da,C as Ia}from"./Calendar-DtIZrfqJ.js";import{u as wa}from"./usePopover-ay_XHQXA.js";import{u as Ca}from"./useInputContainer-zDUZYNNM.js";import{i as ka,k as Oa,w as ge,D as ja}from"./plainDate-C-ANv9VG.js";import{p as xe}from"./dateParser-XTIqkafj.js";import{f as Va,b as za,p as he,i as C,c as Ae,a as qa}from"./timeParser-CAi7zy_b.js";import"./preload-helper-Ct5FWWRu.js";import"./FieldStatus-B_cgkwjT.js";const fe={row:{k1xSpc:"astryx78zum5",kOIVth:"astryx1txdalj",$$css:!0},dateWrapper:{kUk6DE:"astryx98rzlu",kzQI83:null,kmuXW:null,kCS8Yb:"astryx1r8uery",$$css:!0},timeWrapper:{kUk6DE:"astryx98rzlu",kzQI83:null,kmuXW:null,kCS8Yb:"astryx1r8uery",$$css:!0}},Ne={sm:{kZKoxP:"astryx6k0iem",$$css:!0},md:{kZKoxP:"astryx1ueg155",$$css:!0},lg:{kZKoxP:"astryxssyfek",$$css:!0}};function ve(a){if(!a)return{date:void 0,time:void 0};const t=a.indexOf("T");return t===-1?{date:a,time:void 0}:{date:a.slice(0,t),time:a.slice(t+1)}}function N(a,t){if(!(!a||!t))return`${a}T${t}`}function Ma(a){const t=new Date;return Ae({hour:t.getHours(),minute:t.getMinutes(),second:t.getSeconds()},a)}function l({label:a,isLabelHidden:t=!1,description:r,isOptional:k=!1,isRequired:D=!1,isDisabled:w=!1,value:I,onChange:q,changeAction:O,isLoading:ne=!1,min:M,max:W,dateConstraints:Se,hasSeconds:p=!1,hourFormat:re="12h",timeIncrement:se=1,hasClear:Fe=!1,placeholder:Ee="Select a date",timePlaceholder:be="Select a time",timeLabel:$e,size:He,status:o,labelTooltip:Be,numberOfMonths:Ye=1,width:Ue,xstyle:Ke,className:Xe,style:Ze,ref:Qe,...Ge}){const ie=ha(He,"md"),Te=e.useId(),Je=e.useId(),De=e.useId(),Ie=e.useId(),le=e.useRef(null),we=e.useRef(null),Ce=e.useRef(null),ke=e.useRef(null),oe=e.useRef(void 0),[,Oe]=e.useTransition(),[ue,je]=e.useOptimistic(I),j=ne||ue!==I,m=w||j,ea={warning:"warning",error:"error",success:"success"},aa={warning:"warning",error:"error",success:"success"},ta=[r?De:null,o?.message?Ie:null].filter(Boolean).join(" ")||void 0,y=e.useMemo(()=>ve(M),[M]),g=e.useMemo(()=>ve(W),[W]),s=e.useMemo(()=>ve(ue),[ue]),Ve=y.date,ze=g.date,{isDateDisabled:_}=Da({min:Ve,max:ze,dateConstraints:Se}),b=e.useMemo(()=>{if(!(!y.date||!y.time||!s.date))return s.date===y.date?y.time:void 0},[y.date,y.time,s.date]),T=e.useMemo(()=>{if(!(!g.date||!g.time||!s.date))return s.date===g.date?g.time:void 0},[g.date,g.time,s.date]),[v,V]=e.useState(null),qe=e.useRef(s.date);s.date!==qe.current&&(qe.current=s.date,s.date!==oe.current&&(oe.current=void 0,v!==null&&V(null)));const na=v!==null?v:s.date&&/^\d{4}-\d{2}-\d{2}$/.test(s.date)?ka(Oa(s.date),ja):"",de=v===null||!v.trim()?!0:xe(v)!==null,[f,ce]=e.useState(null),[Me,We]=e.useState(!1),_e=re==="12h"?Va:za,me=e.useMemo(()=>f!==null?f:s.time?_e(s.time,p):"",[f,s.time,_e,p]),pe=e.useMemo(()=>{if(f===null||!f.trim())return!0;const i=he(f,p);return i?C(i,b,T):!1},[f,p,b,T]),ra=e.useMemo(()=>Me&&!me?re==="12h"?"e.g., 2:30 PM":"e.g., 14:30":be,[Me,me,re,be]),x=e.useCallback(i=>{j||(q(i),O&&Oe(async()=>{je(i),await O(i)}))},[j,q,O,Oe,je]),u=wa({dialogLabel:"Choose date",closeButtonLabel:"Close calendar",onHide:()=>le.current?.focus()}),sa=e.useCallback(()=>{m||(u.isOpen?u.hide():u.show())},[m,u]),ia=e.useCallback(()=>{!m&&!u.isOpen&&u.show({skipAutoFocus:!0})},[m,u]),z=e.useCallback((i,d)=>{let c=s.time??Ma(p);y.date&&i===y.date&&y.time&&(C(c,y.time,void 0)||(c=y.time)),g.date&&i===g.date&&g.time&&(C(c,void 0,g.time)||(c=g.time));const S=N(i,c);S&&x(S),d==="calendar"&&(V(null),u.hide())},[s.time,p,y,g,x,u]),la=e.useCallback(i=>{const d=i.target.value;V(d);const h=xe(d);if(h&&ge(h)!==s.date&&!_(h)){const c=ge(h);oe.current=c,z(c,"input"),ke.current?.navigateTo(c)}},[s.date,_,z]),R=e.useCallback(()=>{if(v===null)return;if(!v.trim()){I!==void 0&&x(void 0),V(null);return}const i=xe(v);if(i&&!_(i)){const d=ge(i);d!==s.date&&z(d,"input")}V(null)},[v,I,s.date,x,_,z]),oa=e.useCallback(()=>{R()},[R]),ua=e.useCallback(i=>{i.key==="Escape"&&u.isOpen?(i.preventDefault(),u.hide()):i.key==="Enter"&&(i.preventDefault(),R())},[u,R]),da=e.useCallback(i=>{const d=i.target.value;ce(d);const h=he(d,p);if(h&&C(h,b,T)&&h!==s.time&&s.date){const c=N(s.date,h);c&&x(c)}},[p,b,T,s.time,s.date,x]),ca=e.useCallback(()=>We(!0),[]),ma=e.useCallback(()=>{if(We(!1),f===null)return;if(!f.trim()){ce(null);return}const i=he(f,p);if(i&&C(i,b,T)&&i!==s.time&&s.date){const d=N(s.date,i);d&&x(d)}ce(null)},[f,p,b,T,s,x]),pa=e.useCallback(i=>{if(i.key==="ArrowUp"||i.key==="ArrowDown"){i.preventDefault();let d=s.time;if(!d){const S=new Date;d=Ae({hour:S.getHours(),minute:S.getMinutes(),second:S.getSeconds()},p)}const h=i.key==="ArrowUp"?se:-se,c=qa(d,h,p);if(C(c,b,T)&&s.date){const S=N(s.date,c);S&&x(S)}}},[s,p,se,b,T,x]),ya=e.useCallback(()=>{x(void 0),le.current?.focus()},[x]),{onClick:ga,onMouseUp:xa}=Ca({containerRef:Ce,inputRef:we,disabled:m});return n.jsxs(Ta,{label:a,isLabelHidden:t,description:r,inputID:Te,descriptionID:r?De:void 0,isOptional:k,isRequired:D,isDisabled:w,status:o?{type:o.type,message:o.message,messageID:o.message?Ie:void 0}:void 0,labelTooltip:Be,statusVariant:"detached",width:Ue,children:[n.jsxs("div",{...Ge,...Sa(ba("date-time-input",{size:ie,status:o?.type??null}),ye(fe.row,Ke),Xe,Ze),children:[n.jsxs("div",{ref:u.triggerRef,...ye(L.base,Ne[ie],fe.dateWrapper,m&&L.disabled,o&&Le[o.type],o&&Pe[o.type],o&&Re[o.type]),children:[n.jsx("button",{type:"button",onClick:sa,disabled:m,"aria-label":u.isOpen?"Close calendar":"Open calendar",...{0:{className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryx1ypdohk astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto"},1:{className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto astryx1h6gzvc"}}[!!m<<0],children:n.jsx(P,{icon:"calendar",size:"sm",color:"secondary"})}),n.jsx("input",{ref:fa(Qe,le),id:Te,type:"text",role:"combobox",value:na,onChange:la,onBlur:oa,onClick:ia,onKeyDown:ua,placeholder:Ee,disabled:m,"aria-describedby":ta,"aria-required":D===!0?"true":void 0,"aria-invalid":o?.type==="error"||!de?"true":void 0,"aria-busy":j||void 0,"aria-expanded":u.isOpen,"aria-haspopup":"dialog","aria-controls":u.isOpen?u.id:void 0,"aria-autocomplete":"none",autoComplete:"off",...{0:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5"},2:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc"},1:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryxv1l7n4"},3:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc astryxv1l7n4"}}[!!m<<1|!de<<0]}),n.jsx("span",{role:"alert","aria-live":"assertive",className:"astryx10l6tqk astryx1i1rx1s astryxjm9jq1 astryx1717udv astryxkdpibf astryxb3r6kr astryxzpqnlu astryxuxw1ft astryxc342km",children:de?"":"Invalid date"}),Fe&&I!==void 0&&!m&&n.jsx("button",{type:"button",onClick:ya,"aria-label":`Clear ${a}`,className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryx1ypdohk astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto",children:n.jsx(P,{icon:"close",size:"sm",color:"secondary"})}),j&&n.jsx(va,{size:"sm"}),o&&n.jsx(P,{icon:ea[o.type],size:"md",color:aa[o.type]})]}),n.jsxs("div",{ref:Ce,onClick:ga,onMouseUp:xa,...ye(L.base,Ne[ie],fe.timeWrapper,m&&L.disabled,o&&Le[o.type],o&&Pe[o.type],o&&Re[o.type]),children:[n.jsx("div",{className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx2lah0s",children:n.jsx(P,{icon:"clock",size:"sm",color:"secondary"})}),n.jsx("input",{ref:we,id:Je,type:"text",value:me,onChange:da,onFocus:ca,onBlur:ma,onKeyDown:pa,placeholder:ra,disabled:m,"aria-label":$e??`${a} time`,"aria-required":D===!0?"true":void 0,"aria-invalid":o?.type==="error"||!pe?"true":void 0,...{0:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5"},2:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc"},1:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryxv1l7n4"},3:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc astryxv1l7n4"}}[!!m<<1|!pe<<0]}),n.jsx("span",{role:"alert","aria-live":"assertive",className:"astryx10l6tqk astryx1i1rx1s astryxjm9jq1 astryx1717udv astryxkdpibf astryxb3r6kr astryxzpqnlu astryxuxw1ft astryxc342km",children:pe?"":"Invalid time"})]})]}),u.render(n.jsx(Ia,{handleRef:ke,mode:"single",value:s.date,onChange:i=>z(i,"calendar"),min:Ve,max:ze,dateConstraints:Se,numberOfMonths:Ye}),{placement:"below",alignment:"start"})]})}l.displayName="DateTimeInput";l.__docgenInfo={description:`A combined date and time picker with side-by-side date input and
