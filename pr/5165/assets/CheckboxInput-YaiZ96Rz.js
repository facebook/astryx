import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{C as r,M as i,j as a,w as o}from"./tokens.stylex-jQdTQOgY.js";import{F as s,N as c,t as l}from"./utils-DX_YZCyL.js";import{t as u}from"./jsx-runtime-DqZldVDK.js";import{n as d}from"./useTooltip-Dz3niEle.js";import{n as f,t as p}from"./Spinner-s9-d8DDX.js";import{n as m,r as h}from"./hooks-CxL1fQxn.js";import{t as g}from"./Tooltip-ChpUtbet.js";import{a as _,n as v,r as y,t as b}from"./Indicator-CYUYtvvD.js";import{i as x,n as S,r as C,t as w}from"./FieldStatus-Cq8dwWbc.js";var T,E,D=e((()=>{T=t(n(),1),E=(0,T.createContext)(null),E.displayName=`CheckboxListContext`}));function O({label:e,isLabelHidden:t=!1,description:n,onChange:r,changeAction:a,isLoading:l=!1,value:u,isDisabled:p=!1,htmlName:m,disabledMessage:g,isReadOnly:y=!1,isOptional:b=!1,isRequired:x=!1,size:S=`md`,onFocus:T,onBlur:D,labelIcon:O,status:P,width:F,xstyle:I,className:ee,style:te,ref:ne,...L}){let R=(0,k.useId)(),z=(0,k.useId)(),B=(0,k.useId)(),[,V]=(0,k.useTransition)(),[H,U]=(0,k.useOptimistic)(u),W=l||H!==u,G=p&&!!g,K=(0,k.use)(E),q=p&&(G||(K?.hasDisabledMessage??!1)),J=d({placement:`above`,focusTrigger:`always`,isEnabled:G}),Y=_(`checkbox`),X=(0,k.useRef)(null),{focusProps:re}=h(X,p),Z=H===`indeterminate`,Q=H===!0,ie=(0,k.useCallback)(e=>{e&&(e.indeterminate=Z)},[Z]),$=[];n&&$.push(z),P?.message&&$.push(B),G&&$.push(J.describedBy);let ae=$.length>0?$.join(` `):void 0;return(0,A.jsxs)(`div`,{...s(o(`checkbox-input`,{size:S}),i(F!=null&&N.width(F),I),ee,te),children:[(0,A.jsxs)(`div`,{ref:e=>{J.interactionRef(e)},...i(j.container,t&&j.containerLabelHidden,!p&&v),children:[(0,A.jsxs)(`div`,{...i(j.checkboxWrapper,M[S]),...re,children:[(0,A.jsx)(`input`,{...L,ref:c(ne,ie,J.positionRef),id:R,type:`checkbox`,name:p?void 0:m,checked:Q,disabled:p&&!q,"aria-disabled":q?`true`:void 0,form:q?``:void 0,readOnly:y,required:x,onChange:e=>{if(p||W||y)return;let t=e.target.checked;r?.(t,e),a&&!e.defaultPrevented&&V(async()=>{U(t),await a(t,e)})},onFocus:T,onBlur:D,"aria-readonly":y||void 0,"aria-describedby":ae,"aria-invalid":P?.type===`error`?!0:void 0,"aria-busy":W||void 0,...i(j.input,M[S],p&&j.inputDisabled)}),(0,A.jsx)(`span`,{ref:X,className:`astryxjp7ctv`,children:(0,A.jsx)(Y,{state:Z?`indeterminate`:Q?`checked`:`unchecked`,size:S,isDisabled:p,children:W?(0,A.jsx)(f,{size:`sm`,shade:`inherit`}):null})})]}),(0,A.jsx)(`div`,{className:`astryx78zum5 astryxdt5ytf astryx1lsbc85`,children:(0,A.jsx)(C,{label:e,inputID:R,isLabelHidden:t,isDisabled:p,isOptional:b,isRequired:x,labelIcon:O,description:n,descriptionID:z})})]}),P?.message&&(0,A.jsx)(w,{type:P.type,message:P.message,id:B,variant:`detached`}),G&&J.renderTooltip(g)]})}var k,A,j,M,N,P=e((()=>{k=t(n(),1),a(),x(),S(),p(),g(),l(),y(),m(),b(),r(),D(),A=u(),j={container:{k1xSpc:`astryx78zum5`,kGNEyG:`astryx6s0dn4`,kOIVth:`astryx1txdalj`,$$css:!0},containerLabelHidden:{kOIVth:`astryxxhr3t`,$$css:!0},checkboxWrapper:{kVAEAm:`astryx1n2onr6`,k1xSpc:`astryx78zum5`,kGNEyG:`astryx6s0dn4`,kjj79g:`astryxl56j7k`,kmuXW:`astryx2lah0s`,kHBbk8:`astryxc8icb0`,$$css:!0},input:{kVAEAm:`astryx10l6tqk`,kogj98:`astryx1ghz6dp`,kmVPX3:`astryx1717udv`,kSiTet:`astryxg01cxk`,kkrTdU:`astryx1ypdohk`,kY2c9j:`astryx1vjfegm`,k7Eaqz:`astryxkagaj0`,kAzted:`astryx80b3aj`,k87sOh:`astryxijlfn0`,kLqNvP:`astryx1hsn8va`,k3aq6I:`astryx8i4i9p`,$$css:!0},inputDisabled:{kkrTdU:`astryx1h6gzvc`,$$css:!0}},M={sm:{kzqmXN:`astryxw4jnvo`,kZKoxP:`astryx1qx5ct2`,$$css:!0},md:{kzqmXN:`astryxvy4d1p`,kZKoxP:`astryxxk0z11`,$$css:!0}},N={width:e=>[{kzqmXN:e==null?e:`astryx5lhr3w`,$$css:!0},{"--x-width":(e=>typeof e==`number`?e+`px`:e??void 0)(e)}]},O.displayName=`CheckboxInput`,O.__docgenInfo={description:`A checkbox input component for toggling boolean values.
