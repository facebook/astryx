import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{C as r,M as i,d as a,j as o,v as s,w as c}from"./tokens.stylex-jQdTQOgY.js";import{F as l,d as u,t as d}from"./utils-DX_YZCyL.js";import{t as f}from"./jsx-runtime-DqZldVDK.js";import{n as p,t as m}from"./layerAnimations.stylex-C6gLzvT3.js";import{n as h,t as g}from"./useIsomorphicLayoutEffect-AEBSTB0m.js";import{n as _,t as v}from"./InteractiveRoleContext-DtotSF-S.js";import{n as y,t as b}from"./usePopover-DVrT_YrT.js";function x(e){return e.matches(T)?e:e.querySelector(T)}function S({children:e,anchorRef:t,content:n,placement:r=`below`,alignment:a=`start`,isOpen:o,onOpenChange:u,isEnabled:d=!0,width:f,label:m,role:g=`dialog`,isModal:_,hasCloseButton:b,closeButtonLabel:S,hasAutoFocus:T,hasLightDismiss:D=!0,hasEscapeDismiss:O=!0,xstyle:k,className:A,style:j,"data-testid":M}){let N=(0,C.useRef)(null),P=o!==void 0,F=(0,C.useRef)(0),I=y({dialogLabel:m,role:g,isModal:_,hasLightDismiss:D,hasEscapeDismiss:O,hasCloseButton:b,closeButtonLabel:S,hasAutoFocus:T,onShow:(0,C.useCallback)(()=>{u?.(!0)},[u]),onHide:(0,C.useCallback)(()=>{F.current=Date.now(),u?.(!1)},[u])}),L=(0,C.useCallback)(()=>{d&&(Date.now()-F.current<50||I.toggle())},[d,I]),R=(0,C.useCallback)(e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),L())},[L]),z=(0,C.useCallback)(e=>{e.setAttribute(`aria-haspopup`,I.triggerProps[`aria-haspopup`]),e.setAttribute(`aria-expanded`,String(I.triggerProps[`aria-expanded`])),e.setAttribute(`aria-controls`,I.triggerProps[`aria-controls`]),e.addEventListener(`click`,L);let t=e.tagName!==`BUTTON`&&e.getAttribute(`role`)===`button`;return t&&e.addEventListener(`keydown`,R),()=>{e.removeAttribute(`aria-haspopup`),e.removeAttribute(`aria-expanded`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,L),t&&e.removeEventListener(`keydown`,R)}},[I,L,R]);h(()=>{if(!t)return;let e=t.current;if(!e)return;let n=x(e);if(!n)return;I.triggerRef(e);let r=z(n);return()=>{I.triggerRef(null),r()}},[t,I,z]),h(()=>{if(t||typeof e==`function`)return;let n=N.current;if(!n)return;I.triggerRef(n);let r=x(n);if(!r)return;let i=z(r);return()=>{I.triggerRef(null),i()}},[t,I,z]),h(()=>{P&&(o&&!I.isOpen?I.show():!o&&I.isOpen&&I.hide())},[o,P,I]);let B=f?E.customWidth(f):E.matchTrigger;return t&&e==null?(0,w.jsx)(w.Fragment,{children:I.render((0,w.jsx)(`div`,{"data-testid":M,...l(c(`popover`),i(E.contentPadding,k),A,j),children:n}),{placement:r,alignment:a,offset:s[`--spacing-1`],xstyle:[B,p[r]]})}):typeof e==`function`?(0,w.jsxs)(w.Fragment,{children:[e({ref:I.triggerRef,onClick:L,"aria-haspopup":`dialog`,"aria-expanded":I.isOpen,"aria-controls":I.id}),I.render((0,w.jsx)(`div`,{"data-testid":M,...l(c(`popover`),i(E.contentPadding,k),A,j),children:n}),{placement:r,alignment:a,offset:s[`--spacing-1`],xstyle:[B,p[r]]})]}):(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(v,{value:`button`,children:(0,w.jsx)(`div`,{ref:N,className:`astryx3nfvp2`,children:e})}),I.render((0,w.jsx)(`div`,{"data-testid":M,...l(c(`popover`),i(E.contentPadding,k),A,j),children:n}),{placement:r,alignment:a,offset:s[`--spacing-1`],xstyle:[B,p[r]]})]})}var C,w,T,E,D=e((()=>{C=t(n(),1),g(),o(),d(),u(),b(),m(),a(),_(),r(),w=f(),T=`button, [role="button"]`,E={contentPadding:{kLKAdn:`astryx1vlblms`,kGO01o:`astryxvmdzux`,kZCmMZ:`astryx126nfab`,kwRFfy:`astryx1t818jl`,$$css:!0},customWidth:e=>[{kzqmXN:(typeof e==`number`?`${e}px`:e)==null?typeof e==`number`?`${e}px`:e:`astryx5lhr3w`,$$css:!0},{"--x-width":(e=>typeof e==`number`?e+`px`:e??void 0)(typeof e==`number`?`${e}px`:e)}],matchTrigger:{k7Eaqz:`astryxrzjruh`,$$css:!0}},S.displayName=`Popover`,S.__docgenInfo={description:`A click-triggered popover for displaying interactive content anchored to a trigger.
