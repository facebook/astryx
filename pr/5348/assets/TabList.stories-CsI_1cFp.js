...
}`,...O.parameters?.docs?.source},description:{story:'`overflow="none"` opts out: the tabs keep their intrinsic widths and spill\nout of the strip, for a host that handles overflow itself.',...O.parameters?.docs?.description}}},k=[`Default`,`WithMenu`,`MenuWithSelectedChild`,`SizeVariants`,`WithIcons`,`IconOnly`,`WithActions`,`DividerGap`,`FillLayout`,`Overflow`,`OverflowWithDivider`,`OverflowSelectedOffscreen`,`OverflowNone`]}))();export{g as Default,C as DividerGap,w as FillLayout,x as IconOnly,v as MenuWithSelectedChild,T as Overflow,O as OverflowNone,D as OverflowSelectedOffscreen,E as OverflowWithDivider,y as SizeVariants,S as WithActions,b as WithIcons,_ as WithMenu,k as __namedExportsOrder,h as default};