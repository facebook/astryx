...
}`,...m.parameters?.docs?.source},description:{story:`Narrow surface with long decision labels. The dialog itself is the responsive
container: actions stack and labels wrap without treating narrow width as a
proxy for touch input.`,...m.parameters?.docs?.description}}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: () => {
