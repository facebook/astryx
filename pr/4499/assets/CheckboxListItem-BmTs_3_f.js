import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{C as r,I as i,j as a,t as o,w as s}from"./utils-MZubekC4.js";import{t as c}from"./jsx-runtime-DqZldVDK.js";import{n as l}from"./useTooltip-CuYgRONG.js";import{a as u,t as d}from"./i18n-4GW18Wq_.js";import{n as f,t as p}from"./useDevWarning-4fnmV518.js";import{t as m}from"./Tooltip-BVuNYEJ9.js";import{n as h,t as g}from"./Field-BpLMLSce.js";import{a as _,i as v,n as y,o as b,r as x,t as S}from"./ListItem-1g4hVIsN.js";import{i as C,n as w,r as T,t as E}from"./CheckboxInput-1LB5qfv5.js";function D({label:e,isLabelHidden:t=!1,description:n,status:r,value:a,onChange:o,changeAction:c,density:u=`balanced`,hasDividers:d=!1,isDisabled:f=!1,disabledMessage:p,isReadOnly:m=!1,children:h,ref:_,width:v,xstyle:y,className:b,style:S,"data-testid":C,...w}){let E=(0,O.useId)(),D=(0,O.useId)(),j=(0,O.useId)(),M=(0,O.useId)(),[,N]=(0,O.useTransition)(),P=a!==void 0,[F,I]=(0,O.useOptimistic)(a??A),[L,R]=(0,O.useOptimistic)(null),z=f&&!!p,B=l({placement:`above`,focusTrigger:`always`,isEnabled:z}),V=(0,O.useCallback)((e,t)=>{o?.(e),c&&N(async()=>{I(e),t!==void 0&&R(t),await c(e)})},[o,c,N,I,R]),H=(0,O.useMemo)(()=>({value:P?F:void 0,onChange:P?V:void 0,isDisabled:f,hasDisabledMessage:z,isReadOnly:m,loadingValue:L}),[P,F,V,f,z,m,L]);return(0,k.jsxs)(g,{...w,ref:_,"data-testid":C,label:e,isLabelHidden:t,description:n,inputID:E,labelID:D,isGroupLabel:!0,descriptionID:n?j:void 0,isDisabled:f,status:r?{type:r.type,message:r.message,messageID:r.message?M:void 0}:void 0,statusVariant:`detached`,width:v,xstyle:y,...i(s(`checkbox-list`),{className:b,style:S}),children:[(0,k.jsx)(T,{value:H,children:(0,k.jsx)(`div`,{ref:e=>{B.ref(e)},role:`group`,"aria-labelledby":D,"aria-describedby":[n?j:null,r?.message?M:null,z?B.describedBy:null].filter(Boolean).join(` `)||void 0,children:(0,k.jsx)(x,{density:u,hasDividers:d,children:h})})}),z&&B.renderTooltip(p)]})}var O,k,A,j=e((()=>{O=t(n(),1),h(),v(),m(),o(),r(),C(),k=c(),A=[],D.displayName=`CheckboxList`,D.__docgenInfo={description:`A checkbox group component for multi-value selection.
