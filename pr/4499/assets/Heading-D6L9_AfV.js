const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Tooltip-ChRSV1lz.js","./preload-helper-CT_b8DTk.js","./react-B7Te67-h.js","./jsx-runtime-DqZldVDK.js","./useTooltip-CuYgRONG.js","./utils-MZubekC4.js","./layerAnimations.stylex-ooX_WpMw.js","./tokens.stylex-yxVornwx.js","./useIsomorphicLayoutEffect-AEBSTB0m.js"])))=>i.map(i=>d[i]);
import{i as e,n as t,s as n,t as r}from"./preload-helper-CT_b8DTk.js";import{t as i}from"./react-B7Te67-h.js";import{C as a,Ct as o,I as s,P as c,t as l,w as u,wt as d}from"./utils-MZubekC4.js";import{t as f}from"./jsx-runtime-DqZldVDK.js";import{_ as p,a as m,c as h,d as g,f as _,g as v,h as y,i as b,l as x,m as S,o as C,p as w,r as T,s as E,u as D}from"./Text-BpKSdMX5.js";function O({level:e,type:t,accessibilityLevel:n,color:r=`primary`,display:i=`block`,maxLines:a=0,hasTruncateTooltip:o=!0,wordBreak:l,textWrap:f,justify:T=`start`,hasCapsize:D=!1,hasStrikethrough:O=!1,xstyle:N,className:P,style:F,children:I,ref:L,...R}){let z=M[e],B=n&&n!==e?{"aria-level":n}:{},V=l??(a===1?`break-all`:`break-word`),H=a>0||D?`block`:i,U=b({maxLines:a}),W=typeof o==`string`?o:`above`,G=a>0&&o!==!1&&U.isTruncated,K=(0,k.useRef)(null),q=a>1?{WebkitLineClamp:a}:void 0;return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(z,{ref:c(L,U.ref,K),...s(u(`heading`,{level:e,color:r,...t&&{type:t}}),d(C[r],t?w[t]:_[e],t&&h[t],a===1?y.singleLine:a>1?y.multiLine:x[H],a>0&&p[V],f&&S[f],T!==`start`&&g[T],D&&m.enabled,O&&E.strikethrough,N),P,{...F,...q}),title:G?U.fullText:void 0,...B,...R,children:I}),G&&(0,A.jsx)(k.Suspense,{fallback:null,children:(0,A.jsx)(j,{anchorRef:K,content:(0,A.jsx)(`span`,{...d(v.content),children:U.fullText}),placement:W})})]})}var k,A,j,M,N=e((()=>{k=n(i(),1),o(),D(),T(),l(),a(),A=f(),t(),j=(0,k.lazy)(async()=>r(()=>import(`./Tooltip-ChRSV1lz.js`).then(e=>(e.r(),e.n)).then(e=>({default:e.Tooltip})),__vite__mapDeps([0,1,2,3,4,5,6,7,8]),import.meta.url)),M={1:`h1`,2:`h2`,3:`h3`,4:`h4`,5:`h5`,6:`h6`},O.displayName=`Heading`,O.__docgenInfo={description:`Heading - Semantic heading component
