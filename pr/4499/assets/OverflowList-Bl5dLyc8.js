import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{C as r,Ct as i,I as a,P as o,t as s,w as c,wt as l}from"./utils-MZubekC4.js";import{t as u}from"./jsx-runtime-DqZldVDK.js";import{n as d,t as f}from"./useOverflow-D3tXLPhX.js";function p({children:e,gap:t=2,minVisibleItems:n=0,maxVisibleItems:r,maxRows:i,collapseFrom:s=`end`,behavior:u=`observeSelf`,overflowRenderer:f,xstyle:p,className:_,style:x,ref:S,...C}){let w=m.Children.toArray(e),T=w.length,E=b[t],D=u===`observeParent`,O=i!=null&&i>1,{containerRef:k,measureRef:A,visibleCount:j,hasOverflow:M,rowHeight:N}=d(T,{gap:E,minVisibleItems:n,maxVisibleItems:r,maxRows:i,collapseFrom:s,behavior:u}),P=w.map((e,t)=>({child:e,index:t})),F,I;s===`end`?(F=P.slice(0,j),I=P.slice(j)):(F=P.slice(T-j),I=P.slice(0,T-j));let L=f?.(P);return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsxs)(`div`,{ref:A,"aria-hidden":`true`,inert:!0,...l(g.measureContainer,y[t]),children:[w,L!=null&&(0,h.jsx)(`div`,{className:`astryx3nfvp2`,children:L})]}),(0,h.jsxs)(`div`,{ref:o(S,k),...a(c(`overflow-list`),l(O?g.containerMultiRow:g.container,y[t],O&&N>0&&i!=null&&v.height(i,N,E),D&&M&&g.fillParent,p),_,x),...C,children:[s===`start`&&M&&f?.(I),F.map(({child:e})=>e),s===`end`&&M&&f?.(I)]})]})}var m,h,g,_,v,y,b,x=e((()=>{m=t(n(),1),i(),s(),f(),r(),h=u(),g={container:{k1xSpc:`astryx78zum5`,kGNEyG:`astryx6s0dn4`,kVQacm:`astryxb3r6kr`,khDVqt:`astryxuxw1ft`,k7Eaqz:`astryxeuugli`,$$css:!0},containerMultiRow:{k1xSpc:`astryx78zum5`,kwnvtZ:`astryx1a02dak`,kfiyM8:`astryx8gbvx8`,kVQacm:`astryxb3r6kr`,khDVqt:`astryxeaf4i8`,k7Eaqz:`astryxeuugli`,$$css:!0},fillParent:{kzqmXN:`astryxh8yej3`,$$css:!0},measureContainer:{kVAEAm:`astryx10l6tqk`,k33iCy:`astryxlshs6z`,kZKoxP:`astryxqtp20y`,kVQacm:`astryxb3r6kr`,k1xSpc:`astryx78zum5`,kGNEyG:`astryx6s0dn4`,khDVqt:`astryxuxw1ft`,kfzvcC:`astryx47corl`,$$css:!0}},_={kskxy:`astryx1jols5v`,$$css:!0},v={height:(e,t,n)=>[_,{"--x-maxHeight":(e=>typeof e==`number`?e+`px`:e??void 0)(`calc(${t}px * ${e} + ${n}px * ${e-1})`)}]},y={0:{kOIVth:`astryxsn7fz1`,khm7nJ:null,k1C7PZ:null,$$css:!0},1:{kOIVth:`astryxzye2dw`,khm7nJ:null,k1C7PZ:null,$$css:!0},2:{kOIVth:`astryx1txdalj`,khm7nJ:null,k1C7PZ:null,$$css:!0},3:{kOIVth:`astryxjcht0a`,khm7nJ:null,k1C7PZ:null,$$css:!0},4:{kOIVth:`astryx18g69wz`,khm7nJ:null,k1C7PZ:null,$$css:!0},5:{kOIVth:`astryx9mgr7n`,khm7nJ:null,k1C7PZ:null,$$css:!0},6:{kOIVth:`astryx1qh66ti`,khm7nJ:null,k1C7PZ:null,$$css:!0},8:{kOIVth:`astryx4t41sb`,khm7nJ:null,k1C7PZ:null,$$css:!0},10:{kOIVth:`astryx3hoi3v`,khm7nJ:null,k1C7PZ:null,$$css:!0},"0.5":{kOIVth:`astryx1lsbc85`,khm7nJ:null,k1C7PZ:null,$$css:!0},"1.5":{kOIVth:`astryx1s4dlld`,khm7nJ:null,k1C7PZ:null,$$css:!0}},b={0:0,.5:2,1:4,1.5:6,2:8,3:12,4:16,5:20,6:24,8:32,10:40},p.displayName=`OverflowList`,p.__docgenInfo={description:`A horizontal list that hides items that don't fit and shows an overflow indicator.
