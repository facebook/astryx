import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Card-DiixjA7s.js";import{t as a}from"./Card-Ci6bmHtL.js";import{r as o}from"./ListItem-ChtoalT2.js";import{r as s,t as c}from"./CheckboxListItem-BSjrimxv.js";import{i as l,t as u}from"./Link-Bibmf9YZ.js";import{nr as d,yr as f}from"./iframe--fuc3gth.js";var p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N;e((()=>{p=t(n()),f(),d(),a(),u(),m=r(),h={title:`Core/CheckboxList`,component:s,tags:[`autodocs`],argTypes:{label:{control:`text`,description:`Label text (required)`},isLabelHidden:{control:`boolean`,description:`Visually hide the label (still accessible to screen readers)`},description:{control:`text`,description:`Description text displayed below the label`},density:{control:`select`,options:[`compact`,`balanced`,`spacious`],description:`Spacing density for list items`},hasDividers:{control:`boolean`,description:`Whether to show dividers between items`},isDisabled:{control:`boolean`,description:`Whether all checkbox items are disabled`},disabledMessage:{control:`text`,description:`Explains why the group is disabled (whole-group state, not per item). With isDisabled, shows a tooltip on hover/keyboard focus and keeps the checkboxes focusable via aria-disabled (toggling stays blocked). Use this instead of wrapping a disabled CheckboxList in Tooltip.`}}},g={render:e=>{let[t,n]=(0,p.useState)(e.value??[]),{value:r,onChange:i,...a}=e;return(0,m.jsxs)(s,{...a,value:t,onChange:n,children:[(0,m.jsx)(c,{label:`Email`,value:`email`}),(0,m.jsx)(c,{label:`SMS`,value:`sms`}),(0,m.jsx)(c,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`}},_={render:e=>{let[t,n]=(0,p.useState)(e.value??[]),{value:r,onChange:i,...a}=e;return(0,m.jsxs)(s,{...a,value:t,onChange:n,children:[(0,m.jsx)(c,{label:`Email`,value:`email`,description:`Receive notifications via email`}),(0,m.jsx)(c,{label:`SMS`,value:`sms`,description:`Standard messaging rates apply`}),(0,m.jsx)(c,{label:`Push notification`,value:`push`,description:`Instant alerts on your device`})]})},args:{label:`Notification preferences`,description:`Choose how you would like to be notified`,hasDividers:!0}},v={render:e=>{let[t,n]=(0,p.useState)(e.value??[`analytics`]),{value:r,onChange:i,...a}=e;return(0,m.jsxs)(s,{...a,value:t,onChange:n,children:[(0,m.jsx)(c,{label:`Analytics`,value:`analytics`,description:(0,m.jsxs)(m.Fragment,{children:[`Usage data only. `,(0,m.jsx)(l,{href:`#privacy`,children:`Read the policy`})]})}),(0,m.jsx)(c,{label:`Personalization`,value:`personalization`,description:(0,m.jsxs)(m.Fragment,{children:[`Tailors what you see. `,(0,m.jsx)(l,{href:`#privacy`,children:`Learn more`})]})})]})},args:{label:`Data sharing`,description:`A description can carry links and other rich content.`}},y={render:e=>{let t=[{id:`react`,label:`React`},{id:`vue`,label:`Vue`},{id:`angular`,label:`Angular`},{id:`svelte`,label:`Svelte`}],[n,r]=(0,p.useState)([`react`]),{value:i,onChange:a,...o}=e;return(0,m.jsx)(s,{...o,value:n,onChange:r,children:t.map(e=>(0,m.jsx)(c,{label:e.label,value:e.id},e.id))})},args:{label:`Frameworks`}},b={render:()=>{let[e,t]=(0,p.useState)(!1),[n,r]=(0,p.useState)(!0),[i,a]=(0,p.useState)(!1);return(0,m.jsxs)(o,{children:[(0,m.jsx)(c,{label:`Accept terms and conditions`,isChecked:e,onCheck:t}),(0,m.jsx)(c,{label:`Subscribe to newsletter`,description:`Weekly updates about new features`,isChecked:n,onCheck:r}),(0,m.jsx)(c,{label:`Receive marketing emails`,isChecked:i,onCheck:a})]})}},x={render:()=>(0,m.jsxs)(o,{children:[(0,m.jsx)(c,{label:`Completed task`,isChecked:!0}),(0,m.jsx)(c,{label:`Pending task`,isChecked:!1}),(0,m.jsx)(c,{label:`In progress`,isChecked:`indeterminate`})]})},S={render:()=>{let e=[`email`,`sms`,`push`],[t,n]=(0,p.useState)([`email`]),r=e.every(e=>t.includes(e)),i=t.length===0,a=r?!0:i?!1:`indeterminate`;return(0,m.jsxs)(s,{label:`Notifications`,hasDividers:!0,children:[(0,m.jsx)(c,{label:`Select all`,isChecked:a,onCheck:t=>{n(t?[...e]:[])}}),e.map(e=>(0,m.jsx)(c,{label:e.charAt(0).toUpperCase()+e.slice(1),isChecked:t.includes(e),onCheck:t=>{n(n=>t?[...n,e]:n.filter(t=>t!==e))}},e))]})}},C={render:e=>{let[t,n]=(0,p.useState)([`email`]),{value:r,onChange:i,...a}=e;return(0,m.jsxs)(s,{...a,value:t,onChange:n,children:[(0,m.jsx)(c,{label:`Email`,value:`email`}),(0,m.jsx)(c,{label:`SMS`,value:`sms`}),(0,m.jsx)(c,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`,isDisabled:!0}},w={render:()=>{let[e,t]=(0,p.useState)([`email`]);return(0,m.jsxs)(s,{label:`Notification preferences`,value:e,onChange:t,children:[(0,m.jsx)(c,{label:`Email`,value:`email`}),(0,m.jsx)(c,{label:`SMS`,value:`sms`,isLoading:!0}),(0,m.jsx)(c,{label:`Push notification`,value:`push`})]})}},T={render:()=>{let[e,t]=(0,p.useState)([`email`]);return(0,m.jsxs)(s,{label:`Notification preferences`,description:`Toggle an option — it spins while saving`,value:e,changeAction:e=>new Promise(n=>{setTimeout(()=>{t(e),n()},1500)}),hasDividers:!0,children:[(0,m.jsx)(c,{label:`Email`,value:`email`}),(0,m.jsx)(c,{label:`SMS`,value:`sms`}),(0,m.jsx)(c,{label:`Push notification`,value:`push`})]})}},E={render:e=>{let[t,n]=(0,p.useState)([]),{value:r,onChange:i,...a}=e;return(0,m.jsxs)(s,{...a,value:t,onChange:n,children:[(0,m.jsx)(c,{label:`Email`,value:`email`}),(0,m.jsx)(c,{label:`SMS`,value:`sms`,isDisabled:!0}),(0,m.jsx)(c,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`}},D={render:e=>{let[t,n]=(0,p.useState)([]),{value:r,onChange:i,...a}=e;return(0,m.jsxs)(s,{...a,value:t,onChange:n,children:[(0,m.jsx)(c,{label:`Email`,value:`email`}),(0,m.jsx)(c,{label:`SMS`,value:`sms`}),(0,m.jsx)(c,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`,status:{type:`error`,message:`Please select at least one notification method`}}},O={render:e=>{let[t,n]=(0,p.useState)([`free`]),{value:r,onChange:i,...a}=e;return(0,m.jsxs)(s,{...a,value:t,onChange:n,children:[(0,m.jsx)(c,{label:`Free tier`,value:`free`,description:`Basic features included`,endContent:(0,m.jsx)(`span`,{style:{color:`#0D8626`},children:`$0/mo`})}),(0,m.jsx)(c,{label:`Pro tier`,value:`pro`,description:`Advanced features`,endContent:(0,m.jsx)(`span`,{style:{color:`#0064E0`},children:`$9/mo`})}),(0,m.jsx)(c,{label:`Enterprise`,value:`enterprise`,description:`Custom solutions`,endContent:(0,m.jsx)(`span`,{style:{color:`#5B08D8`},children:`Custom`})})]})},args:{label:`Add-on packages`,hasDividers:!0}},k={render:()=>{let[e,t]=(0,p.useState)([]),[n,r]=(0,p.useState)([`email`]),[i,a]=(0,p.useState)(!1),[l,u]=(0,p.useState)(!0);return(0,m.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`24px`,maxWidth:`400px`},children:[(0,m.jsxs)(s,{label:`Unselected`,value:e,onChange:t,children:[(0,m.jsx)(c,{label:`Option A`,value:`a`}),(0,m.jsx)(c,{label:`Option B`,value:`b`})]}),(0,m.jsxs)(s,{label:`Pre-selected`,value:n,onChange:r,children:[(0,m.jsx)(c,{label:`Email`,value:`email`}),(0,m.jsx)(c,{label:`SMS`,value:`sms`})]}),(0,m.jsxs)(s,{label:`Disabled group`,value:[`a`],onChange:()=>{},isDisabled:!0,children:[(0,m.jsx)(c,{label:`Option A`,value:`a`}),(0,m.jsx)(c,{label:`Option B`,value:`b`})]}),(0,m.jsxs)(s,{label:`With descriptions`,value:e,onChange:t,hasDividers:!0,children:[(0,m.jsx)(c,{label:`Email`,value:`email`,description:`Delivered to your inbox`}),(0,m.jsx)(c,{label:`SMS`,value:`sms`,description:`Standard rates apply`})]}),(0,m.jsxs)(s,{label:`With error`,value:[],onChange:()=>{},status:{type:`error`,message:`Please select at least one option`},children:[(0,m.jsx)(c,{label:`Option A`,value:`a`}),(0,m.jsx)(c,{label:`Option B`,value:`b`})]}),(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`h4`,{style:{margin:`0 0 8px`},children:`Standalone mode`}),(0,m.jsxs)(o,{children:[(0,m.jsx)(c,{label:`Accept terms`,isChecked:i,onCheck:a}),(0,m.jsx)(c,{label:`Subscribe`,isChecked:l,onCheck:u})]})]})]})}},A={render(){let[e,t]=(0,p.useState)([`email`]);return(0,m.jsx)(`div`,{style:{maxWidth:400},children:(0,m.jsx)(i,{children:(0,m.jsxs)(s,{label:`Notifications`,description:`Choose how to be notified`,value:e,onChange:t,children:[(0,m.jsx)(c,{value:`email`,label:`Email`,description:`Weekly digest`}),(0,m.jsx)(c,{value:`push`,label:`Push notifications`}),(0,m.jsx)(c,{value:`sms`,label:`SMS`,isDisabled:!0})]})})})}},j={render(){let[e,t]=(0,p.useState)([`admin`]);return(0,m.jsx)(`div`,{style:{maxWidth:400},children:(0,m.jsx)(i,{children:(0,m.jsxs)(s,{label:`Assign Roles`,value:e,onChange:t,hasDividers:!0,children:[(0,m.jsx)(c,{value:`admin`,label:`Admin`}),(0,m.jsx)(c,{value:`editor`,label:`Editor`}),(0,m.jsx)(c,{value:`viewer`,label:`Viewer`}),(0,m.jsx)(c,{value:`guest`,label:`Guest`})]})})})}},M={render:e=>{let[t,n]=(0,p.useState)([`email`]),{value:r,onChange:i,...a}=e;return(0,m.jsxs)(s,{...a,value:t,onChange:n,children:[(0,m.jsx)(c,{label:`Email`,value:`email`}),(0,m.jsx)(c,{label:`SMS`,value:`sms`}),(0,m.jsx)(c,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`,isDisabled:!0,disabledMessage:`Notifications are managed by your administrator`}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: args => {
  ...
  render: args => {
    ...
    return <CheckboxList {...restArgs} value={value} onChange={setValue}>
        <CheckboxListItem label="Analytics" value="analytics" description={<>
  ...
  args: {
    label: 'Data sharing',
    description: 'A description can carry links and other rich content.'
  }
