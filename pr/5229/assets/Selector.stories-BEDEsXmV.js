...
}`,...q.parameters?.docs?.source},description:{story:`The same Selector with no theme, for comparison: a checkmark on the selected
row, and nothing at all on the others.`,...q.parameters?.docs?.description}}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
  render: () => {
    const [value, setValue] = useState<string | undefined>('Banana');
...
}`,...J.parameters?.docs?.source},description:{story:`\`indicatorPosition="start"\` moves the mark to the leading edge, the way a
...
without the column only the chosen label would be indented.`,...J.parameters?.docs?.description}}},Y=`Default.HiddenLabel.WithDescription.WithObjects.WithIcons.WithSections.SearchableWithSections.Searchable.CustomRender.SizeVariants.GhostVariant.WithStatus.OptionalRequired.Disabled.DisabledWithMessage.PreSelected.AllVariations.Clearable.ClearableWithStatus.PlacementAbove.Placements.StatusVariantComparison.ThemedIcons.RadioSelectionIndicator.DefaultSelectionIndicator.StartIndicatorPosition`.split(`.`)}))();export{L as AllVariations,R as Clearable,z as ClearableWithStatus,k as CustomRender,x as Default,q as DefaultSelectionIndicator,P as Disabled,F as DisabledWithMessage,j as GhostVariant,S as HiddenLabel,N as OptionalRequired,B as PlacementAbove,V as Placements,I as PreSelected,K as RadioSelectionIndicator,O as Searchable,D as SearchableWithSections,A as SizeVariants,J as StartIndicatorPosition,H as StatusVariantComparison,W as ThemedIcons,C as WithDescription,T as WithIcons,w as WithObjects,E as WithSections,M as WithStatus,Y as __namedExportsOrder,b as default};