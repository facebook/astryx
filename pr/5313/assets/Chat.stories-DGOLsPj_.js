import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./jsx-runtime-DqZldVDK.js";import{t as n}from"./Text-UAS9zcOf.js";import{t as r}from"./Button-Cm4zLZQJ.js";import{t as i}from"./Button-DQvARvKw.js";import{i as a,t as o}from"./Avatar-BJ9h1kW3.js";import{i as s,t as c}from"./CodeBlock-c57fxToL.js";import{a as l}from"./VStack-D2hkegyx.js";import{t as u}from"./Stack-B_1FY01Z.js";import{t as d}from"./Text-udrQkxTB.js";import{n as f,t as p}from"./Token-C8a33O7T.js";import{C as m,Dr as h,Fr as g,Nr as _,gr as v,hr as y,jr as b,kr as x,mi as S,pi as C,vr as w,w as T}from"./iframe-B2K-Xl1P.js";import{Xt as E,ft as D,t as O,ut as k}from"./esm-CL1f8dHF.js";var A,j,M,N,P,F,I,L,R,z,B,V;e((()=>{w(),o(),C(),d(),y(),p(),u(),c(),i(),m(),O(),A=t(),j={title:`Core/Chat`,component:g,tags:[`autodocs`]},M={name:`Default`,render:()=>(0,A.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(g,{children:[(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{metadata:(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:30:00`,format:`time`}),status:`read`}),children:`How should I handle state management in a React app?`})}),(0,A.jsxs)(_,{sender:`assistant`,children:[(0,A.jsx)(v,{density:`compact`,children:`For most cases, **React's built-in state** is sufficient:
...
Avoid global state managers unless you have a genuine need for cross-cutting state. Most apps are over-engineered in this area.`}),(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:30:30`,format:`time`}),footer:(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`span`,{children:`Claude Opus 4.6`}),(0,A.jsx)(`span`,{children:`·`}),(0,A.jsx)(r,{label:`Thumbs up`,icon:(0,A.jsx)(k,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0}),(0,A.jsx)(r,{label:`Thumbs down`,icon:(0,A.jsx)(D,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0}),(0,A.jsx)(r,{label:`Copy`,icon:(0,A.jsx)(E,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0})]})})]}),(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{metadata:(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:31:00`,format:`time`}),status:`read`}),children:`Can you show me a useReducer example?`})}),(0,A.jsxs)(_,{sender:`assistant`,children:[(0,A.jsx)(v,{density:`compact`,children:`Here's a common pattern for form state:`}),(0,A.jsx)(s,{code:`const reducer = (state, action) => {
  switch (action.type) {
    case 'SET_FIELD':
...
const [state, dispatch] = useReducer(reducer, initialState);`,language:`tsx`}),(0,A.jsx)(v,{density:`compact`,children:"This keeps all your form logic in one place. The reducer is pure and easy to test — just pass in state and action, assert on the output.\n\n| Hook | Use case | Re-renders | Complexity | Best for |\n|------|----------|------------|------------|----------|\n| `useState` | Simple values | On every set | Low | Toggles, inputs, counters |\n| `useReducer` | Complex state logic | On dispatch | Medium | Forms, multi-field state |\n| `useContext` | Shared subtree state | All consumers | Low | Theme, auth, locale |\n| `useSyncExternalStore` | External stores | On snapshot change | High | Redux, Zustand, signals |\n| `useRef` | Mutable values | Never | Low | DOM refs, timers, previous values |"}),(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:31:30`,format:`time`}),footer:(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`span`,{children:`Claude Opus 4.6`}),(0,A.jsx)(`span`,{children:`·`}),(0,A.jsx)(r,{label:`Thumbs up`,icon:(0,A.jsx)(k,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0}),(0,A.jsx)(r,{label:`Thumbs down`,icon:(0,A.jsx)(D,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0}),(0,A.jsx)(r,{label:`Copy`,icon:(0,A.jsx)(E,{style:{width:14,height:14}}),variant:`ghost`,size:`sm`,isIconOnly:!0})]})})]})]})})},N={name:`Mixed Content`,render:()=>(0,A.jsx)(`div`,{style:{height:600,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(g,{children:[(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{children:`Show me the component files and explain the architecture`})}),(0,A.jsxs)(_,{sender:`assistant`,children:[(0,A.jsx)(b,{children:`Sure! Here's an overview of the component architecture.`}),(0,A.jsx)(b,{variant:`ghost`,children:(0,A.jsx)(v,{density:`compact`,children:`The system uses a **compound component** pattern with three layers:

1. **MessageList** — scrollable container with auto-scroll
2. **Message** — layout wrapper with sender context
3. **Bubble** — styled content container`})}),(0,A.jsxs)(b,{variant:`ghost`,children:[(0,A.jsx)(v,{density:`compact`,children:`Here are the files:`}),(0,A.jsxs)(l,{gap:2,wrap:`wrap`,children:[(0,A.jsx)(f,{label:`Button.tsx`}),(0,A.jsx)(f,{label:`Card.tsx`}),(0,A.jsx)(f,{label:`Dialog.tsx`})]}),(0,A.jsx)(s,{code:`export * from './Button';
export * from './Card';
export * from './Dialog';`,language:`typescript`})]}),(0,A.jsx)(b,{children:`Let me know which one to open — I can walk through the implementation.`})]}),(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{children:`Open Button.tsx`})}),(0,A.jsx)(h,{children:`Navi opened Button.tsx`}),(0,A.jsx)(_,{sender:`assistant`,children:(0,A.jsxs)(b,{variant:`ghost`,children:[(0,A.jsx)(s,{code:`import * as stylex from '@stylexjs/stylex';
...
}`,language:`tsx`}),(0,A.jsx)(v,{density:`compact`,children:`The Button uses StyleX for styles and reads variant from props.`})]})})]})})},P={name:`Custom Content`,render:()=>(0,A.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(g,{style:{maxWidth:520},children:[(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{children:`Can you pull up the Q3 report?`})}),(0,A.jsxs)(_,{sender:`assistant`,children:[(0,A.jsx)(b,{name:`Navi`,children:`Sure, here is the artifact from last quarter.`}),(0,A.jsx)(b,{variant:`ghost`,width:`100%`,metadata:(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:32:00`,format:`time`}),footer:(0,A.jsx)(`span`,{children:`Claude Opus 4.6`})}),children:(0,A.jsxs)(S,{label:`Open Q3 performance report`,onClick:()=>{},children:[(0,A.jsx)(n,{type:`body`,weight:`semibold`,display:`block`,children:`Q3 Performance Report`}),(0,A.jsx)(n,{type:`supporting`,color:`secondary`,display:`block`,children:`12 pages · updated 2 days ago`})]})})]})]})})},F={name:`Chat Conversation`,render:()=>{let e={fontSize:12,fontWeight:600,color:`#666`,lineHeight:`16px`};return(0,A.jsx)(`div`,{style:{height:500,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(g,{children:[(0,A.jsx)(h,{variant:`divider`,children:`Today`}),(0,A.jsx)(_,{sender:`assistant`,avatar:(0,A.jsx)(a,{name:`Navi`,size:`md`}),children:(0,A.jsx)(b,{name:(0,A.jsx)(`span`,{style:e,children:`Navi`}),metadata:(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:30:00`,format:`time`})}),children:`Hey! I looked at the PR and left a few comments on the density styles.`})}),(0,A.jsxs)(_,{sender:`user`,avatar:(0,A.jsx)(a,{name:`Cindy`,size:`md`}),children:[(0,A.jsx)(b,{group:`first`,name:(0,A.jsx)(`span`,{style:e,children:`Cindy`}),children:`Thanks! I'll take a look.`}),(0,A.jsx)(b,{group:`last`,metadata:(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:31:00`,format:`time`}),status:`read`}),children:`Should be quick to fix.`})]}),(0,A.jsx)(_,{sender:`assistant`,avatar:(0,A.jsx)(a,{name:`Navi`,size:`md`}),children:(0,A.jsx)(b,{name:(0,A.jsx)(`span`,{style:e,children:`Navi`}),metadata:(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:32:00`,format:`time`})}),children:`Sounds good. The main thing is the compact radius — it should use the container token, not the page token.`})}),(0,A.jsx)(_,{sender:`user`,avatar:(0,A.jsx)(a,{name:`Cindy`,size:`md`}),children:(0,A.jsx)(b,{name:(0,A.jsx)(`span`,{style:e,children:`Cindy`}),metadata:(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:33:00`,format:`time`}),status:`delivered`}),children:`Good catch, fixed and pushed.`})}),(0,A.jsx)(h,{children:`Cindy liked a message`})]})})}},I={name:`Density Comparison`,render:()=>{let e={compact:`sm`,balanced:`md`,spacious:`md`},t=t=>(0,A.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,minWidth:0,border:`1px solid var(--color-border-primary)`,borderRadius:8},children:[(0,A.jsx)(`div`,{style:{padding:`8px 12px`,borderBottom:`1px solid var(--color-border-primary)`,fontSize:12,fontWeight:600,textTransform:`uppercase`,letterSpacing:`0.05em`},children:t}),(0,A.jsx)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,minHeight:0},children:(0,A.jsxs)(g,{density:t,children:[(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{children:`How does the density system work?`})}),(0,A.jsx)(_,{sender:`assistant`,avatar:(0,A.jsx)(a,{name:`Navi`,size:e[t]}),children:(0,A.jsx)(v,{density:`compact`,children:`Density controls **spacing** at every level:
...
This is the **${t}** density. ${t===`compact`?`Great for sidebars and panels where space is limited.`:t===`spacious`?`Ideal for long-form reading where breathing room helps comprehension.`:`The default — works well for most full-page chat interfaces.`}`})}),(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{children:`Makes sense, thanks!`})})]})})]});return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:16,height:500},children:[t(`compact`),t(`balanced`),t(`spacious`)]})}},L={name:`Message Gap Override`,render:()=>(0,A.jsx)(`div`,{style:{height:420,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(g,{density:`compact`,gap:5,children:[(0,A.jsx)(_,{sender:`assistant`,children:(0,A.jsx)(b,{name:`Clio`,children:`Starting the requested change.`})}),(0,A.jsx)(_,{sender:`assistant`,children:(0,A.jsx)(b,{variant:`ghost`,children:`Reading repository context and relevant files...`})}),(0,A.jsx)(_,{sender:`assistant`,children:(0,A.jsx)(b,{variant:`ghost`,children:`Running tests for the updated package.`})}),(0,A.jsx)(_,{sender:`assistant`,children:(0,A.jsx)(b,{metadata:(0,A.jsx)(x,{footer:`Done`}),children:`The patch is ready for review.`})})]})})},R={name:`System Messages`,render:()=>(0,A.jsx)(`div`,{style:{height:400,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(g,{children:[(0,A.jsx)(h,{variant:`divider`,children:`March 15, 2026`}),(0,A.jsx)(_,{sender:`assistant`,avatar:(0,A.jsx)(a,{name:`Navi`,size:`md`}),children:(0,A.jsx)(v,{density:`compact`,children:`Good morning!`})}),(0,A.jsx)(h,{children:`Conversation started`}),(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{children:`Hey Navi`})}),(0,A.jsx)(h,{variant:`divider`,children:`Today`}),(0,A.jsx)(h,{children:`Cindy shared a file`})]})})},z={name:`Message Status`,render:()=>(0,A.jsx)(`div`,{style:{height:400,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(g,{children:[(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{metadata:(0,A.jsx)(x,{status:`sending`}),children:`Sending...`})}),(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{metadata:(0,A.jsx)(x,{status:`sent`}),children:`Sent`})}),(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{metadata:(0,A.jsx)(x,{status:`delivered`}),children:`Delivered`})}),(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{metadata:(0,A.jsx)(x,{status:`read`}),children:`Read`})}),(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{metadata:(0,A.jsx)(x,{status:`error`}),children:`Failed to send`})})]})})},B={name:`Multi-Bubble Grouping`,render:()=>(0,A.jsx)(`div`,{style:{height:500,display:`flex`,flexDirection:`column`},children:(0,A.jsxs)(g,{children:[(0,A.jsxs)(_,{sender:`user`,children:[(0,A.jsx)(b,{group:`first`,children:`Hey, can you review my PR?`}),(0,A.jsx)(b,{group:`middle`,children:`It's the one for the chat components`}),(0,A.jsx)(b,{group:`last`,metadata:(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:31:00`,format:`time`}),status:`delivered`}),children:`Link: github.com/facebook/astryx/pull/1180`})]}),(0,A.jsxs)(_,{sender:`assistant`,avatar:(0,A.jsx)(a,{name:`Navi`,size:`md`}),children:[(0,A.jsx)(b,{group:`first`,children:`Sure, looking at it now!`}),(0,A.jsx)(b,{group:`middle`,children:`The compound pattern looks solid. A few minor comments on the density styles.`}),(0,A.jsx)(b,{group:`last`,metadata:(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:33:00`,format:`time`})}),children:`I'll leave them as review comments.`})]}),(0,A.jsx)(_,{sender:`user`,children:(0,A.jsx)(b,{metadata:(0,A.jsx)(x,{timestamp:(0,A.jsx)(T,{value:`2026-03-15T14:34:00`,format:`time`}),status:`sending`}),children:`Thanks, will address those`})})]})})},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  name: 'Default',
  render: () => <div style={{
    display: 'flex',
...
}`,...B.parameters?.docs?.source}}},V=[`Default`,`MixedContent`,`CustomContent`,`ChatConversation`,`DensityComparison`,`GapOverride`,`SystemMessages`,`MessageStatus`,`MultiBubble`]}))();export{F as ChatConversation,P as CustomContent,M as Default,I as DensityComparison,L as GapOverride,z as MessageStatus,N as MixedContent,B as MultiBubble,R as SystemMessages,V as __namedExportsOrder,j as default};