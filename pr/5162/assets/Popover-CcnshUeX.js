import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{d as r,v as i}from"./tokens.stylex-jQdTQOgY.js";import{d as a}from"./utils-DX_YZCyL.js";import{t as o}from"./jsx-runtime-DqZldVDK.js";import{n as s,t as c}from"./layerAnimations.stylex-C6gLzvT3.js";import{n as l,t as u}from"./useIsomorphicLayoutEffect-AEBSTB0m.js";import{n as d,t as f}from"./InteractiveRoleContext-DtotSF-S.js";import{n as p,t as m}from"./usePopover-DkVwgfVd.js";function h(e){return e.matches(y)?e:e.querySelector(y)}function g({children:e,anchorRef:t,content:n,placement:r=`below`,alignment:a=`start`,isOpen:o,onOpenChange:c,isEnabled:u=!0,width:d,label:m,role:g=`dialog`,isModal:y,hasCloseButton:x,closeButtonLabel:S,hasAutoFocus:C,hasLightDismiss:w=!0,hasEscapeDismiss:T=!0,xstyle:E,className:D,style:O,"data-testid":k}){let A=(0,_.useRef)(null),j=o!==void 0,M=(0,_.useRef)(0),N=(0,_.useCallback)(()=>{c?.(!0)},[c]),P=(0,_.useCallback)(()=>{M.current=Date.now(),c?.(!1)},[c]),F=p({dialogLabel:m,role:g,isModal:y,hasLightDismiss:w,hasEscapeDismiss:T,hasCloseButton:x,closeButtonLabel:S,hasAutoFocus:C,surfaceTarget:`popover`,xstyle:[b.contentPadding,E],onShow:N,onHide:P}),I=(0,_.useCallback)(()=>{u&&(Date.now()-M.current<50||F.toggle())},[u,F]),L=(0,_.useCallback)(e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),I())},[I]),R=(0,_.useCallback)(e=>{e.setAttribute(`aria-haspopup`,F.triggerProps[`aria-haspopup`]),e.setAttribute(`aria-expanded`,String(F.triggerProps[`aria-expanded`])),e.setAttribute(`aria-controls`,F.triggerProps[`aria-controls`]),e.addEventListener(`click`,I);let t=e.tagName!==`BUTTON`&&e.getAttribute(`role`)===`button`;return t&&e.addEventListener(`keydown`,L),()=>{e.removeAttribute(`aria-haspopup`),e.removeAttribute(`aria-expanded`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,I),t&&e.removeEventListener(`keydown`,L)}},[F,I,L]);l(()=>{if(!t)return;let e=t.current;if(!e)return;let n=h(e);if(!n)return;F.triggerRef(e);let r=R(n);return()=>{F.triggerRef(null),r()}},[t,F,R]),l(()=>{if(t||typeof e==`function`)return;let n=A.current;if(!n)return;F.triggerRef(n);let r=h(n);if(!r)return;let i=R(r);return()=>{F.triggerRef(null),i()}},[t,F,R]),l(()=>{j&&(o&&!F.isOpen?F.show():!o&&F.isOpen&&F.hide())},[o,j,F]);let z=d?b.customWidth(d):b.matchTrigger;return t&&e==null?(0,v.jsx)(v.Fragment,{children:F.render((0,v.jsx)(`div`,{"data-testid":k,className:D,style:O,children:n}),{placement:r,alignment:a,offset:i[`--spacing-1`],xstyle:[z,s[r]]})}):typeof e==`function`?(0,v.jsxs)(v.Fragment,{children:[e({ref:F.triggerRef,onClick:I,"aria-haspopup":`dialog`,"aria-expanded":F.isOpen,"aria-controls":F.id}),F.render((0,v.jsx)(`div`,{"data-testid":k,className:D,style:O,children:n}),{placement:r,alignment:a,offset:i[`--spacing-1`],xstyle:[z,s[r]]})]}):(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(f,{value:`button`,children:(0,v.jsx)(`div`,{ref:A,className:`astryx3nfvp2`,children:e})}),F.render((0,v.jsx)(`div`,{"data-testid":k,className:D,style:O,children:n}),{placement:r,alignment:a,offset:i[`--spacing-1`],xstyle:[z,s[r]]})]})}var _,v,y,b,x=e((()=>{_=t(n(),1),u(),a(),m(),c(),r(),d(),v=o(),y=`button, [role="button"]`,b={contentPadding:{kLKAdn:`astryx1vlblms`,kGO01o:`astryxvmdzux`,kZCmMZ:`astryx126nfab`,kwRFfy:`astryx1t818jl`,kE3dHu:null,kpe85a:null,$$css:!0},customWidth:e=>[{kzqmXN:(typeof e==`number`?`${e}px`:e)==null?typeof e==`number`?`${e}px`:e:`astryx5lhr3w`,$$css:!0},{"--x-width":(e=>typeof e==`number`?e+`px`:e??void 0)(typeof e==`number`?`${e}px`:e)}],matchTrigger:{k7Eaqz:`astryxrzjruh`,$$css:!0}},g.displayName=`Popover`,g.__docgenInfo={description:`A click-triggered popover for displaying interactive content anchored to a trigger.
