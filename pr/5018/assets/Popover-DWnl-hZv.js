import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{D as r,E as i,F as a,P as o,b as s,p as c}from"./ime-Dy4QRKoo.js";import{F as l,d as u,t as d}from"./utils-BiEIGw-d.js";import{t as f}from"./jsx-runtime-DqZldVDK.js";import{n as p,t as m}from"./layerAnimations.stylex-B62WPN_a.js";import{n as h,t as g}from"./useIsomorphicLayoutEffect-AEBSTB0m.js";import{n as _,t as v}from"./InteractiveRoleContext-DtotSF-S.js";import{n as y,t as b}from"./usePopover-CFVg42aq.js";function x(e){return e.matches(T)?e:e.querySelector(T)}function S({children:e,anchorRef:t,content:n,placement:i=`below`,alignment:o=`start`,isOpen:c,onOpenChange:u,isEnabled:d=!0,width:f,label:m,role:g=`dialog`,isModal:_,hasCloseButton:b,closeButtonLabel:S,hasAutoFocus:T,hasLightDismiss:D=!0,hasEscapeDismiss:O=!0,xstyle:k,className:A,style:j,"data-testid":M}){let N=(0,C.useRef)(null),P=c!==void 0,F=y({dialogLabel:m,role:g,isModal:_,hasLightDismiss:D,hasEscapeDismiss:O,hasCloseButton:b,closeButtonLabel:S,hasAutoFocus:T,onShow:(0,C.useCallback)(()=>{u?.(!0)},[u]),onHide:(0,C.useCallback)(()=>{u?.(!1)},[u])}),I=(0,C.useCallback)(()=>{d&&F.toggle()},[d,F]),L=(0,C.useCallback)(e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),I())},[I]),R=(0,C.useCallback)(e=>{e.setAttribute(`aria-haspopup`,F.triggerProps[`aria-haspopup`]),e.setAttribute(`aria-expanded`,String(F.triggerProps[`aria-expanded`])),e.setAttribute(`aria-controls`,F.triggerProps[`aria-controls`]),e.addEventListener(`click`,I);let t=e.tagName!==`BUTTON`&&e.getAttribute(`role`)===`button`;return t&&e.addEventListener(`keydown`,L),()=>{e.removeAttribute(`aria-haspopup`),e.removeAttribute(`aria-expanded`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,I),t&&e.removeEventListener(`keydown`,L)}},[F,I,L]);h(()=>{if(!t)return;let e=t.current;if(!e)return;let n=x(e);if(!n)return;F.triggerRef(e);let r=R(n);return()=>{F.triggerRef(null),r()}},[t,F,R]),h(()=>{if(t||typeof e==`function`)return;let n=N.current;if(!n)return;F.triggerRef(n);let r=x(n);if(!r)return;let i=R(r);return()=>{F.triggerRef(null),i()}},[t,F,R]),h(()=>{P&&(c&&!F.isOpen?F.show():!c&&F.isOpen&&F.hide())},[c,P,F]);let z=f?E.customWidth(f):E.matchTrigger;return t&&e==null?(0,w.jsx)(w.Fragment,{children:F.render((0,w.jsx)(`div`,{"data-testid":M,...l(r(`popover`),a(E.contentPadding,k),A,j),children:n}),{placement:i,alignment:o,offset:s[`--spacing-1`],xstyle:[z,p[i]]})}):typeof e==`function`?(0,w.jsxs)(w.Fragment,{children:[e({ref:F.triggerRef,onClick:I,"aria-haspopup":`dialog`,"aria-expanded":F.isOpen,"aria-controls":F.id}),F.render((0,w.jsx)(`div`,{"data-testid":M,...l(r(`popover`),a(E.contentPadding,k),A,j),children:n}),{placement:i,alignment:o,offset:s[`--spacing-1`],xstyle:[z,p[i]]})]}):(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(v,{value:`button`,children:(0,w.jsx)(`div`,{ref:N,className:`astryx3nfvp2`,children:e})}),F.render((0,w.jsx)(`div`,{"data-testid":M,...l(r(`popover`),a(E.contentPadding,k),A,j),children:n}),{placement:i,alignment:o,offset:s[`--spacing-1`],xstyle:[z,p[i]]})]})}var C,w,T,E,D=e((()=>{C=t(n(),1),g(),o(),d(),u(),b(),m(),c(),_(),i(),w=f(),T=`button, [role="button"]`,E={contentPadding:{kLKAdn:`astryx1vlblms`,kGO01o:`astryxvmdzux`,kZCmMZ:`astryx126nfab`,kwRFfy:`astryx1t818jl`,$$css:!0},customWidth:e=>[{kzqmXN:(typeof e==`number`?`${e}px`:e)==null?typeof e==`number`?`${e}px`:e:`astryx5lhr3w`,$$css:!0},{"--x-width":(e=>typeof e==`number`?e+`px`:e??void 0)(typeof e==`number`?`${e}px`:e)}],matchTrigger:{k7Eaqz:`astryxrzjruh`,$$css:!0}},S.displayName=`Popover`,S.__docgenInfo={description:`A click-triggered popover for displaying interactive content anchored to a trigger.
