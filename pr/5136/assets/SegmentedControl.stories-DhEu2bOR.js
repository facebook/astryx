import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Icon-aeuwryOS.js";import{t as a}from"./Icon-DeqRYbQn.js";import{dn as o,fn as s,mn as c}from"./iframe-ykbOPaJ_.js";import{J as l,t as u,v as d,w as f}from"./esm-CL1f8dHF.js";var p,m,h,g,_,v,y,b,x,S,C,w,T,E;e((()=>{p=t(n()),o(),a(),u(),m=r(),h={title:`Core/SegmentedControl`,component:c,tags:[`autodocs`],argTypes:{size:{control:`select`,options:[`sm`,`md`,`lg`],description:`Size variant for the control`},isDisabled:{control:`boolean`,description:`Whether the entire control is disabled`},disabledMessage:{control:`text`,description:`Explains why the control is disabled (whole-group state, not per segment). With isDisabled, shows a tooltip on hover/keyboard focus and keeps the control focusable via aria-disabled (selection stays blocked). Use this instead of wrapping a disabled SegmentedControl in Tooltip.`}}},g={args:{size:`md`,isDisabled:!1},render:e=>{let[t,n]=(0,p.useState)(`grid`);return(0,m.jsxs)(c,{value:t,onChange:n,label:`View mode`,size:e.size,isDisabled:e.isDisabled,children:[(0,m.jsx)(s,{value:`grid`,label:`Grid`}),(0,m.jsx)(s,{value:`list`,label:`List`}),(0,m.jsx)(s,{value:`table`,label:`Table`})]})}},_={args:{size:`md`},render:e=>{let[t,n]=(0,p.useState)(`grid`);return(0,m.jsxs)(c,{value:t,onChange:n,label:`View mode`,size:e.size,children:[(0,m.jsx)(s,{value:`grid`,label:`Grid`,icon:(0,m.jsx)(i,{icon:f,color:`inherit`})}),(0,m.jsx)(s,{value:`list`,label:`List`,icon:(0,m.jsx)(i,{icon:l,color:`inherit`})}),(0,m.jsx)(s,{value:`table`,label:`Table`,icon:(0,m.jsx)(i,{icon:d,color:`inherit`})})]})}},v={args:{size:`sm`},render:e=>{let[t,n]=(0,p.useState)(`grid`);return(0,m.jsxs)(c,{value:t,onChange:n,label:`View mode`,size:e.size,children:[(0,m.jsx)(s,{value:`grid`,label:`Grid`,isLabelHidden:!0,icon:(0,m.jsx)(i,{icon:f,color:`inherit`})}),(0,m.jsx)(s,{value:`list`,label:`List`,isLabelHidden:!0,icon:(0,m.jsx)(i,{icon:l,color:`inherit`})})]})}},y={render:()=>{let[e,t]=(0,p.useState)(`day`);return(0,m.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`24px`},children:[(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`div`,{style:{marginBottom:`8px`,fontSize:`12px`,color:`#666`},children:`Small`}),(0,m.jsxs)(c,{value:e,onChange:t,label:`Time period`,size:`sm`,children:[(0,m.jsx)(s,{value:`day`,label:`Day`}),(0,m.jsx)(s,{value:`week`,label:`Week`}),(0,m.jsx)(s,{value:`month`,label:`Month`})]})]}),(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`div`,{style:{marginBottom:`8px`,fontSize:`12px`,color:`#666`},children:`Medium (default)`}),(0,m.jsxs)(c,{value:e,onChange:t,label:`Time period`,size:`md`,children:[(0,m.jsx)(s,{value:`day`,label:`Day`}),(0,m.jsx)(s,{value:`week`,label:`Week`}),(0,m.jsx)(s,{value:`month`,label:`Month`})]})]}),(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`div`,{style:{marginBottom:`8px`,fontSize:`12px`,color:`#666`},children:`Large`}),(0,m.jsxs)(c,{value:e,onChange:t,label:`Time period`,size:`lg`,children:[(0,m.jsx)(s,{value:`day`,label:`Day`}),(0,m.jsx)(s,{value:`week`,label:`Week`}),(0,m.jsx)(s,{value:`month`,label:`Month`})]})]})]})}},b={render:()=>{let[e,t]=(0,p.useState)(`all`);return(0,m.jsxs)(c,{value:e,onChange:t,label:`Filter`,isDisabled:!0,children:[(0,m.jsx)(s,{value:`all`,label:`All`}),(0,m.jsx)(s,{value:`active`,label:`Active`}),(0,m.jsx)(s,{value:`completed`,label:`Completed`})]})}},x={render:()=>{let[e,t]=(0,p.useState)(`hourly`);return(0,m.jsxs)(c,{value:e,onChange:t,label:`Data granularity`,children:[(0,m.jsx)(s,{value:`hourly`,label:`Hourly`}),(0,m.jsx)(s,{value:`daily`,label:`Daily`}),(0,m.jsx)(s,{value:`weekly`,label:`Weekly`,isDisabled:!0})]})}},S={render:()=>{let[e,t]=(0,p.useState)(`all`);return(0,m.jsxs)(c,{value:e,onChange:t,label:`Filter`,isDisabled:!0,disabledMessage:`Choose a project to filter tasks`,children:[(0,m.jsx)(s,{value:`all`,label:`All`}),(0,m.jsx)(s,{value:`active`,label:`Active`}),(0,m.jsx)(s,{value:`completed`,label:`Completed`})]})}},C={args:{size:`md`,isDisabled:!1},render:e=>{let[t,n]=(0,p.useState)(`needs-me`);return(0,m.jsxs)(c,{value:t,onChange:n,label:`Sessions`,size:e.size,isDisabled:e.isDisabled,children:[(0,m.jsx)(s,{value:`needs-me`,label:`Needs me`,count:12,countLabel:`sessions`}),(0,m.jsx)(s,{value:`running`,label:`Running`,count:3,countLabel:`sessions`}),(0,m.jsx)(s,{value:`finished`,label:`Recently finished`,count:148,countLabel:`sessions`}),(0,m.jsx)(s,{value:`archived`,label:`Archived`,count:0,countLabel:`sessions`})]})}},w={args:{size:`md`},render:e=>{let[t,n]=(0,p.useState)(`grid`);return(0,m.jsxs)(c,{value:t,onChange:n,label:`View mode`,size:e.size,children:[(0,m.jsx)(s,{value:`grid`,label:`Grid`,isLabelHidden:!0,icon:(0,m.jsx)(i,{icon:f,color:`inherit`}),count:24,countLabel:`items`}),(0,m.jsx)(s,{value:`list`,label:`List`,isLabelHidden:!0,icon:(0,m.jsx)(i,{icon:l,color:`inherit`}),count:8,countLabel:`items`}),(0,m.jsx)(s,{value:`table`,label:`Table`,isLabelHidden:!0,icon:(0,m.jsx)(i,{icon:d,color:`inherit`}),count:132,countLabel:`items`})]})}},T={render:()=>{let[e,t]=(0,p.useState)(`needs-me`);return(0,m.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`},children:[520,380,280].map(n=>(0,m.jsx)(`div`,{style:{width:n},children:(0,m.jsxs)(c,{value:e,onChange:t,label:`Sessions`,layout:`fill`,children:[(0,m.jsx)(s,{value:`needs-me`,label:`Needs me`,count:12,countLabel:`sessions`}),(0,m.jsx)(s,{value:`running`,label:`Running`,count:3,countLabel:`sessions`}),(0,m.jsx)(s,{value:`finished`,label:`Finished`,count:148,countLabel:`sessions`})]})},n))})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  ...
  render: args => {
    ...
    return <SegmentedControl value={value} onChange={setValue} label="Sessions" size={args.size} isDisabled={args.isDisabled}>
        <SegmentedControlItem value="needs-me" label="Needs me" count={12} countLabel="sessions" />
        <SegmentedControlItem value="running" label="Running" count={3} countLabel="sessions" />
        <SegmentedControlItem value="finished" label="Recently finished" count={148} countLabel="sessions" />
        <SegmentedControlItem value="archived" label="Archived" count={0} countLabel="sessions" />
      </SegmentedControl>;
  }
  ...
  render: args => {
    const [value, setValue] = useState('grid');
    return <SegmentedControl value={value} onChange={setValue} label="View mode" size={args.size}>
        <SegmentedControlItem value="grid" label="Grid" isLabelHidden icon={<Icon icon={Squares2X2Icon} color="inherit" />} count={24} countLabel="items" />
        <SegmentedControlItem value="list" label="List" isLabelHidden icon={<Icon icon={ListBulletIcon} color="inherit" />} count={8} countLabel="items" />
        <SegmentedControlItem value="table" label="Table" isLabelHidden icon={<Icon icon={TableCellsIcon} color="inherit" />} count={132} countLabel="items" />
      </SegmentedControl>;
  }
  ...
  render: () => {
    ...
    return <div style={{
      ...
      gap: '16px'
        ...
        {[520, 380, 280].map(width => <div key={width} style={{
        width
      }}>
            <SegmentedControl value={value} onChange={setValue} label="Sessions" layout="fill">
              <SegmentedControlItem value="needs-me" label="Needs me" count={12} countLabel="sessions" />
              <SegmentedControlItem value="running" label="Running" count={3} countLabel="sessions" />
              <SegmentedControlItem value="finished" label="Finished" count={148} countLabel="sessions" />
            </SegmentedControl>
          </div>)}
      </div>;
  }
}`,...T.parameters?.docs?.source}}},E=[`Default`,`WithIcons`,`IconOnly`,`SizeVariants`,`Disabled`,`DisabledItem`,`DisabledWithMessage`,`WithCounts`,`IconOnlyWithCounts`,`CountsFillLayout`]}))();export{T as CountsFillLayout,g as Default,b as Disabled,x as DisabledItem,S as DisabledWithMessage,v as IconOnly,w as IconOnlyWithCounts,y as SizeVariants,C as WithCounts,_ as WithIcons,E as __namedExportsOrder,h as default};