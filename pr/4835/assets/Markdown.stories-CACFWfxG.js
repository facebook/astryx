...
`),g={args:{children:m}},_={args:{children:m,density:`compact`}},v={name:`AI Response`,args:{children:h,density:`compact`,headingLevelStart:3}},y={name:`Shifted Headings (start at h3)`,args:{children:m,headingLevelStart:3}},b={name:`Inline Display`,render:()=>(0,f.jsxs)(`div`,{style:{maxWidth:680,display:`grid`,gap:16},children:[(0,f.jsx)(r,{type:`large`,display:`block`,children:(0,f.jsx)(c,{display:`inline`,children:"Use `value` with **controlled state** and [read the docs](https://example.com) without creating block wrappers."})}),(0,f.jsxs)(`div`,{style:{border:`1px solid #ddd`,borderRadius:8,padding:12,display:`grid`,gap:6},children:[(0,f.jsx)(r,{type:`body`,weight:`bold`,display:`block`,children:`Prop description`}),(0,f.jsx)(r,{type:`body`,color:`secondary`,display:`block`,children:(0,f.jsx)(c,{display:`inline`,children:'Accepts an action item `{label, onClick?, icon?}`, a divider `{type: "divider"}`, or a section `{type: "section", items: [...]}`.'})})]})]})},x={name:`Table`,args:{children:[`## Comparison Table`,``,`| Feature | React | Vue | Svelte |`,`|:--------|:-----:|:---:|-------:|`,`| Virtual DOM | Yes | Yes | No |`,`| Bundle Size | ~40KB | ~30KB | ~2KB |`,`| TypeScript | Native | Plugin | Native |`,`| Learning Curve | Medium | Easy | Easy |`].join(`
