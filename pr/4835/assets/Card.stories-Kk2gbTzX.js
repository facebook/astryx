...
}`,...L.parameters?.docs?.source},description:{story:"All background color variants in one view.\n`muted` uses the wash background for de-emphasised cards;\nthe non-semantic variants use the `--color-<name>-background` token.",...L.parameters?.docs?.description}}},R=[`Default`,`WithSimpleContent`,`Elevations`,`WithInnerLayout`,`Sizes`,`FixedHeight`,`NestedCards`,`NestedSections`,`SingleSection`,`MixedContent`,`FullBleed`,`OnBackgrounds`,`Callout`,`ColorVariants`]})))()}z();export{I as Callout,L as ColorVariants,w as Default,E as Elevations,k as FixedHeight,P as FullBleed,N as MixedContent,A as NestedCards,j as NestedSections,F as OnBackgrounds,M as SingleSection,O as Sizes,D as WithInnerLayout,T as WithSimpleContent,R as __namedExportsOrder,C as default};