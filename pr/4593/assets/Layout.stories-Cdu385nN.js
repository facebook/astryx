  ...
  render: () => <div {...stylex.props(styles.pageWrapper, styles.pageWrapperTall)}>
      <Card width="100%" maxWidth={900} height={400}>
        <Layout header={<LayoutHeader hasDivider>
            ...
            </LayoutHeader>} start={<LayoutPanel hasDivider hideBelow="md" role="navigation">
            ...
            </LayoutContent>} end={<LayoutPanel hasDivider hideBelow="lg" width={260}>
...
}`,...Y.parameters?.docs?.source}}},X=[`Playground`,`BasicCard`,`WithSidebar`,`DualPanels`,`ResponsiveHiddenPanels`,`NoDividers`,`FullBleedContent`,`SectionVariants`,`ContentOnly`,`ThemedLayout`,`OuterPaddingDemo`,`ContentWidthWithDividers`,`ContentWidthWithStartPanel`,`ContentWidthWithBothPanels`,`ContentWidthNoDividers`,`ContentWidthNarrower`,`ContentWidthWider`,`ContentWidthResponsive`,`ContentWidthInAppShell`]}))();export{M as BasicCard,z as ContentOnly,Y as ContentWidthInAppShell,K as ContentWidthNarrower,G as ContentWidthNoDividers,J as ContentWidthResponsive,q as ContentWidthWider,W as ContentWidthWithBothPanels,H as ContentWidthWithDividers,U as ContentWidthWithStartPanel,P as DualPanels,L as FullBleedContent,I as NoDividers,V as OuterPaddingDemo,j as Playground,F as ResponsiveHiddenPanels,R as SectionVariants,B as ThemedLayout,N as WithSidebar,X as __namedExportsOrder,A as default};