import{ah as n,aL as F,aH as Y,a1 as e,a6 as L,af as M,ay as E,a7 as B,I as f}from"./iframe-FpdBIrKz.js";import{F as G}from"./Squares2X2Icon-CeXxR_DR.js";import{F as H}from"./ListBulletIcon-NOn48BhK.js";import"./preload-helper-Ct5FWWRu.js";const $=n.createContext(null);$.displayName="SegmentedControlContext";function P(){const t=n.use($);if(t==null)throw new Error("useSegmentedControlContext must be used within SegmentedControl. Wrap your SegmentedControlItem in <SegmentedControl>.");return t}const D={container:{k1xSpc:"astryx3nfvp2",kGNEyG:"astryx6s0dn4",kOIVth:"astryx1lsbc85","--_segmented-control-padding":"astryx18jk3ff",kmVPX3:"astryxpoxszi",kWkggS:"astryx17x4s8c",$$css:!0},fill:{k1xSpc:"astryx78zum5",kzqmXN:"astryxh8yej3",$$css:!0},disabled:{kSiTet:"astryxbyyjgo",kfzvcC:"astryx47corl",$$css:!0}},X={sm:{"--_segmented-control-radius":"astryx9icjy1",kaIpWk:"astryx1hapoqb",krdFHd:null,kfmiAY:null,kVL7Gh:null,kT0f0o:null,kIxVMA:null,ksF3WI:null,kqGeR4:null,kYm2EN:null,$$css:!0},md:{"--_segmented-control-radius":"astryx9icjy1",kaIpWk:"astryx1hapoqb",krdFHd:null,kfmiAY:null,kVL7Gh:null,kT0f0o:null,kIxVMA:null,ksF3WI:null,kqGeR4:null,kYm2EN:null,$$css:!0},lg:{"--_segmented-control-radius":"astryx9icjy1",kaIpWk:"astryx1hapoqb",krdFHd:null,kfmiAY:null,kVL7Gh:null,kT0f0o:null,kIxVMA:null,ksF3WI:null,kqGeR4:null,kYm2EN:null,$$css:!0}};function o({ref:t,value:a,onChange:s,label:c,size:S,layout:k="hug",isDisabled:r=!1,children:i,xstyle:u,className:b,style:T}){const m=F(S,"md"),v=n.useRef(null),A=n.useCallback(p=>{if(r)return;const g=v.current;if(!g)return;const d=Array.from(g.querySelectorAll('[role="radio"]:not([aria-disabled="true"])'));if(d.length===0)return;const x=d.findIndex(R=>R===document.activeElement);let h;switch(p.key){case"ArrowRight":h=x===-1?0:(x+1)%d.length;break;case"ArrowLeft":h=x===-1?d.length-1:(x-1+d.length)%d.length;break;case"Home":h=0;break;case"End":h=d.length-1;break;default:return}p.preventDefault();const q=d[h];q.focus();const W=q.dataset.value;W!=null&&s(W)},[r,s]),N=n.useMemo(()=>({value:a,onChange:s,size:m,layout:k,isDisabled:r}),[a,s,m,k,r]);return Y(()=>{const p=v.current;if(!p)return;const g=Array.from(p.querySelectorAll('[role="radio"]:not([aria-disabled="true"])'));if(g.length===0)return;g.some(x=>x.tabIndex===0)||(g[0].tabIndex=0)}),e.jsx($,{value:N,children:e.jsx("div",{ref:B(t,v),role:"radiogroup","aria-label":c,"aria-disabled":r||void 0,onKeyDown:A,...L(E("segmented-control",{size:m}),M(D.container,X[m],k==="fill"&&D.fill,r&&D.disabled,u),b,T),children:i})})}o.displayName="SegmentedControl";o.__docgenInfo={description:`Segmented button group for single selection (radio group semantics).
