import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./jsx-runtime-DqZldVDK.js";import{t as n}from"./Text-D67_5egO.js";import{t as r}from"./Heading-JRJOM-dL.js";import{c as i}from"./Stack-3jiL_lX6.js";import{t as a}from"./Text-932QNy-o.js";import{u as o}from"./iframe-CLFAq6o4.js";import{D as s,L as c,N as l,j as u,k as d,t as f,ut as p,z as m}from"./src-BsPy-WMF.js";var h,g,_,v,y,b,x,S,C,w;e((()=>{f(),o(),a(),h=t(),g={title:`Lab/ThreeDChart`,tags:[`autodocs`]},_=Array.from({length:200},()=>({x:Math.random()*100,y:Math.random()*100,z:Math.random()*100})),v={render:()=>{let e=p();return(0,h.jsxs)(i,{direction:`vertical`,gap:4,children:[(0,h.jsx)(r,{level:3,children:`3D Scatter Plot`}),(0,h.jsx)(n,{type:`supporting`,color:`secondary`,children:`200 points. Drag to rotate. Depth encoded via size and opacity.`}),(0,h.jsxs)(m,{data:_,xKey:`x`,yKey:`y`,zKey:`z`,height:400,interactive:!0,children:[(0,h.jsx)(u,{}),(0,h.jsx)(d,{}),(0,h.jsx)(c,{color:e.categorical(1)[0],radius:4})]})]})}},y=[{product:0,region:0,sales:42},{product:1,region:0,sales:58},{product:2,region:0,sales:35},{product:0,region:1,sales:65},{product:1,region:1,sales:48},{product:2,region:1,sales:72},{product:0,region:2,sales:30},{product:1,region:2,sales:55},{product:2,region:2,sales:40}],b={render:()=>{let e=p();return(0,h.jsxs)(i,{direction:`vertical`,gap:4,children:[(0,h.jsx)(r,{level:3,children:`3D Bar Chart`}),(0,h.jsx)(n,{type:`supporting`,color:`secondary`,children:`Sales by product x region. Drag to rotate.`}),(0,h.jsxs)(m,{data:y,xKey:`product`,yKey:`sales`,zKey:`region`,height:400,interactive:!0,children:[(0,h.jsx)(u,{divisions:3}),(0,h.jsx)(d,{}),(0,h.jsx)(l,{color:e.categorical(1)[0],barWidth:.12,barDepth:.12})]})]})}},x=[];for(let e=0;e<=20;e++)for(let t=0;t<=20;t++){let n=e/20,r=t/20,i=Math.sin(n*Math.PI*2)*Math.cos(r*Math.PI*2)*50+50;x.push({x:e,y:Math.round(i),z:t})}S={render:()=>{let e=p();return(0,h.jsxs)(i,{direction:`vertical`,gap:4,children:[(0,h.jsx)(r,{level:3,children:`3D Surface`}),(0,h.jsx)(n,{type:`supporting`,color:`secondary`,children:`sin(x) * cos(z) surface. Drag to rotate. Color maps to height.`}),(0,h.jsxs)(m,{data:x,xKey:`x`,yKey:`y`,zKey:`z`,height:450,interactive:!0,children:[(0,h.jsx)(u,{}),(0,h.jsx)(d,{}),(0,h.jsx)(s,{colorRange:e.sequential.blue(5)})]})]})}},C={render:()=>{let e=p();return(0,h.jsxs)(i,{direction:`vertical`,gap:4,children:[(0,h.jsx)(r,{level:3,children:`3D Wireframe`}),(0,h.jsxs)(m,{data:x,xKey:`x`,yKey:`y`,zKey:`z`,height:450,interactive:!0,children:[(0,h.jsx)(u,{}),(0,h.jsx)(s,{colorRange:e.sequential.teal(5),wireframe:!0})]})]})}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  render: () => {
