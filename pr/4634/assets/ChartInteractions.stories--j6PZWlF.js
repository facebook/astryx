import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Text-D67_5egO.js";import{t as a}from"./Heading-JRJOM-dL.js";import{c as o}from"./Stack-3jiL_lX6.js";import{t as s}from"./Text-932QNy-o.js";import{u as c}from"./iframe-CLFAq6o4.js";import{$ as l,Ct as u,Ft as d,Lt as f,Nt as p,at as m,jt as h,pt as g,rt as _,t as v,tt as y,ut as b,zt as x}from"./src-BsPy-WMF.js";import{n as S,t as C}from"./useDataset-D0R9TzHE.js";var w,T,E,D,O,k,A,j,M,N,P,F;e((()=>{w=t(n()),v(),c(),s(),C(),T=r(),E={title:`Lab/Chart Interactions`,tags:[`autodocs`]},D=[{month:`Jan`,revenue:4200,expenses:2800},{month:`Feb`,revenue:3800,expenses:2600},{month:`Mar`,revenue:5100,expenses:3200},{month:`Apr`,revenue:4600,expenses:2900},{month:`May`,revenue:5400,expenses:3100},{month:`Jun`,revenue:6200,expenses:3400},{month:`Jul`,revenue:5800,expenses:3300},{month:`Aug`,revenue:5500,expenses:3e3},{month:`Sep`,revenue:4900,expenses:2700},{month:`Oct`,revenue:5200,expenses:3100},{month:`Nov`,revenue:5700,expenses:3200},{month:`Dec`,revenue:6800,expenses:3600}],O={render:()=>{let e=b(),[t,n]=(0,w.useState)(null);return(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`1D Brush — Bar Chart`}),(0,T.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`Drag to select a range. `,t??`Click to clear.`]}),(0,T.jsxs)(x,{data:D,xKey:`month`,yKeys:[`revenue`],height:300,children:[(0,T.jsx)(d,{horizontal:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(p,{dataKey:`revenue`,color:e.categorical(1)[0]}),(0,T.jsx)(m,{onBrush:(e,t)=>n(`${t.length} months selected`),onClear:()=>n(null)})]})]})}},k={render:()=>{let e=b(),[t,n]=(0,w.useState)(null);return(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`1D Brush — Line Chart`}),(0,T.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`Drag to select a range. `,t??`Click to clear.`]}),(0,T.jsxs)(x,{data:D,xKey:`month`,yKeys:[`revenue`,`expenses`],height:300,children:[(0,T.jsx)(d,{horizontal:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(h,{dataKey:`revenue`,color:e.categorical(2)[0],dots:!0}),(0,T.jsx)(h,{dataKey:`expenses`,color:e.categorical(2)[1],dots:!0}),(0,T.jsx)(m,{onBrush:(e,t)=>n(`${t.length} months selected`),onClear:()=>n(null)})]})]})}},A={render:()=>{let e=b(),[t]=S(`cars.json`),[n,r]=(0,w.useState)(null),s=(0,w.useMemo)(()=>t.filter(e=>e.Horsepower!=null&&e.Miles_per_Gallon!=null).map(e=>({hp:e.Horsepower,mpg:e.Miles_per_Gallon})),[t]);return s.length?(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`2D Brush — Scatter Plot`}),(0,T.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`Drag a rectangle to select.`,` `,n==null?`Click to clear.`:`${n} points selected.`]}),(0,T.jsxs)(x,{data:s,xKey:`hp`,yKeys:[`mpg`],yBaseline:`data`,height:350,children:[(0,T.jsx)(d,{horizontal:!0,vertical:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(u,{dataKey:`mpg`,color:e.categorical(1)[0],radius:3}),(0,T.jsx)(m,{mode:`xy`,onBrush:(e,t)=>r(t.length),onClear:()=>r(null)})]})]}):(0,T.jsx)(i,{type:`supporting`,children:`Loading…`})}},j={render:()=>{let e=b(),[t]=S(`cars.json`),n=(0,w.useMemo)(()=>t.filter(e=>e.Horsepower!=null&&e.Miles_per_Gallon!=null).map(e=>({hp:e.Horsepower,mpg:e.Miles_per_Gallon})),[t]);return n.length?(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`Crosshair`}),(0,T.jsxs)(x,{data:n,xKey:`hp`,yKeys:[`mpg`],yBaseline:`data`,height:350,children:[(0,T.jsx)(d,{horizontal:!0,vertical:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(u,{dataKey:`mpg`,color:e.categorical(1)[0],radius:3}),(0,T.jsx)(g,{crosshair:`xy`,crosshairLabels:!0,xFormat:e=>`${Math.round(Number(e))} hp`,yFormat:e=>`${Math.round(e)} mpg`})]})]}):(0,T.jsx)(i,{type:`supporting`,children:`Loading…`})}},M={render:()=>{let e=b(),[t]=S(`cars.json`),n=(0,w.useMemo)(()=>t.filter(e=>e.Horsepower!=null&&e.Miles_per_Gallon!=null).map(e=>({hp:e.Horsepower,mpg:e.Miles_per_Gallon})),[t]),[r,s]=(0,w.useState)([40,230]),[c,l]=(0,w.useState)([8,47]);return n.length?(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`Zoom & Pan`}),(0,T.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`Scroll to zoom, drag to pan. x: [`,Math.round(r[0]),`,`,` `,Math.round(r[1]),`]`]}),(0,T.jsxs)(x,{data:n,xKey:`hp`,yKeys:[`mpg`],xDomain:r,yDomain:c,height:350,children:[(0,T.jsx)(d,{horizontal:!0,vertical:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(u,{dataKey:`mpg`,color:e.categorical(1)[0],radius:3}),(0,T.jsx)(_,{onXDomainChange:s,onYDomainChange:l})]})]}):(0,T.jsx)(i,{type:`supporting`,children:`Loading…`})}},N={render:()=>{let e=b(),[t]=S(`cars.json`),n=(0,w.useMemo)(()=>t.filter(e=>e.Horsepower!=null&&e.Miles_per_Gallon!=null).map(e=>({hp:e.Horsepower,mpg:e.Miles_per_Gallon})),[t]),[r,s]=(0,w.useState)([]);return n.length?(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`Click to Select`}),(0,T.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`Click a point. Shift-click for multi. `,r.length,` selected.`]}),(0,T.jsxs)(x,{data:n,xKey:`hp`,yKeys:[`mpg`],yBaseline:`data`,height:350,children:[(0,T.jsx)(d,{horizontal:!0,vertical:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(u,{dataKey:`mpg`,color:e.categorical(1)[0],radius:3}),(0,T.jsx)(y,{selected:r,onSelectionChange:s})]})]}):(0,T.jsx)(i,{type:`supporting`,children:`Loading…`})}},P={render:()=>{let e=b();return(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`Reference Lines`}),(0,T.jsxs)(x,{data:D,xKey:`month`,yKeys:[`revenue`],height:300,children:[(0,T.jsx)(d,{horizontal:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(p,{dataKey:`revenue`,color:e.categorical(1)[0]}),(0,T.jsx)(l,{y:5e3,label:`Target`,color:e.semantic.positive}),(0,T.jsx)(l,{y:4700,label:`Average`,color:e.semantic.neutral})]})]})}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  render: () => {
