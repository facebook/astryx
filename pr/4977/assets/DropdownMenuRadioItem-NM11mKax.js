import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{A as r,C as i,j as a}from"./tokens.stylex-Dlps2mzj.js";import{F as o,t as s}from"./utils-CS5QvixW.js";import{t as c}from"./jsx-runtime-DqZldVDK.js";import{r as l}from"./Icon-yadpUkvL.js";import{t as u}from"./Icon-CrT6Mhfu.js";import{n as d,t as f}from"./Item-CVwskFFS.js";import{f as p,h as m,l as h,m as g,p as _,u as v}from"./renderDropdownItems-BgM2ozW8.js";import{a as y,t as b}from"./Indicator-B3u75e2d.js";function x({label:e,description:t,icon:n,value:r,onChange:a,isDisabled:s=!1,hasCloseOnSelect:c=!1,endContent:u,xstyle:f,className:p,style:m,..._}){let v=g(),b=v?.menuSize??`md`,x=b===`sm`?`sm`:`md`,T=y(`checkbox`),E=(0,S.useCallback)(()=>{s||(a?.(!r),c&&v?.closeMenu())},[s,a,r,c,v]),D=(0,S.useCallback)(e=>h(e,s),[s]);return(0,C.jsx)(d,{..._,role:`menuitemcheckbox`,"aria-checked":r,tabIndex:s?void 0:-1,onPointerMove:D,marker:(0,C.jsx)(T,{state:r?`checked`:`unchecked`,size:x,isDisabled:s,xstyle:w.marker}),startContent:n?l(n,{size:`sm`,color:`secondary`}):void 0,label:e,description:t,endContent:u,onClick:E,isDisabled:s,xstyle:[w.root,s&&w.disabled,f],...o(i(`dropdown-menu-item`,{size:b}),{className:p,style:m})})}var S,C,w,T=e((()=>{S=t(n(),1),u(),b(),f(),_(),v(),s(),C=c(),w={root:{kzqmXN:`astryxh8yej3`,kaIpWk:`astryx1ws5lxm`,krdFHd:null,kfmiAY:null,kVL7Gh:null,kT0f0o:null,kIxVMA:null,ksF3WI:null,kqGeR4:null,kYm2EN:null,kMwMTN:`astryx1tgivj0`,kWkggS:`astryxjbqb8w astryx1c52tdz`,kkrTdU:`astryx1ypdohk`,kI3sdo:`astryx1a2a7pz`,kjBf7l:null,kInvED:null,k3XXqK:null,kMeerF:null,$$css:!0},disabled:{kSiTet:`astryxbyyjgo`,kkrTdU:`astryx1h6gzvc`,$$css:!0},marker:{kfzvcC:`astryx47corl`,kayTVb:`astryx1g77sc7 astryxozvky`,keTefX:`astryx1lziwak astryx1jymrmb`,koQZXg:null,km5ZXQ:null,$$css:!0}},x.displayName=`DropdownMenuCheckboxItem`,x.__docgenInfo={description:`A checkable dropdown menu item (role="menuitemcheckbox").
...
shortcut hint or badge.`}},composes:[`Omit`]}}));function E({value:e,onChange:t,label:n,hasCloseOnSelect:r=!0,children:i,xstyle:s,className:c,style:l,...u}){let d=(0,D.useMemo)(()=>({value:e,onChange:t,hasCloseOnSelect:r}),[e,t,r]);return(0,O.jsx)(`div`,{...u,role:`group`,"aria-label":n,...o(a(k.group,s),{className:c,style:l}),children:(0,O.jsx)(p,{value:d,children:i})})}var D,O,k,A=e((()=>{D=t(n(),1),r(),s(),_(),O=c(),k={group:{k1xSpc:`astryx78zum5`,kXwgrk:`astryxdt5ytf`,kOIVth:`astryx1lsbc85`,$$css:!0}},E.displayName=`DropdownMenuRadioGroup`,E.__docgenInfo={description:`A single-select group of radio menu items (role="group" of menuitemradio).
