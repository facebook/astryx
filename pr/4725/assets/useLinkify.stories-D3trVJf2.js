import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Text-DPDLQbJL.js";import{c as a,t as o}from"./Stack-3jiL_lX6.js";import{t as s}from"./Text-D87pUsOr.js";import{n as c,t as l}from"./TextInput-9rLxk0hq.js";import{r as u,t as d}from"./Link-BbCx930B.js";function f({text:e,hasBuiltins:t,hasTaskPattern:n,hasDiffPattern:r}){let o=[];n&&o.push({pattern:/\bT(\d+)\b/g,href:e=>`https://tasks.example.com/${e[1]}`,isExternal:!0}),r&&o.push({pattern:/\bD(\d+)\b/g,href:e=>`https://phabricator.example.com/${e[0]}`,isExternal:!0});let s=u(e,{patterns:o.length>0?o:void 0,hasBuiltins:t});return(0,m.jsxs)(a,{gap:4,children:[(0,m.jsx)(`div`,{style:{padding:16,borderRadius:8,background:`var(--color-background-muted, #f5f5f5)`,minHeight:40},children:(0,m.jsx)(i,{type:`body`,children:s})}),(0,m.jsxs)(i,{type:`supporting`,color:`secondary`,children:[s.length,` node`,s.length===1?``:`s`,` rendered`]})]})}var p,m,h,g,_,v,y,b,x,S,C;e((()=>{p=t(n()),d(),s(),o(),l(),m=r(),h={title:`Core/useLinkify`,component:f,tags:[`autodocs`],argTypes:{text:{control:`text`},hasBuiltins:{control:`boolean`},hasTaskPattern:{control:`boolean`},hasDiffPattern:{control:`boolean`}}},g={args:{text:`Check out https://react.dev and also https://github.com/facebook/react for the source.`,hasBuiltins:!0,hasTaskPattern:!1,hasDiffPattern:!1}},_={args:{text:`Contact us at support@example.com or sales@example.com for help.`,hasBuiltins:!0,hasTaskPattern:!1,hasDiffPattern:!1}},v={name:`Custom patterns (T/D numbers)`,args:{text:`Fixed in T123456 and D789012. Also see T999.`,hasBuiltins:!0,hasTaskPattern:!0,hasDiffPattern:!0}},y={args:{text:`See T123456 for the task. The fix is in D789012. Docs at https://example.com/docs. Questions? Email team@example.com.`,hasBuiltins:!0,hasTaskPattern:!0,hasDiffPattern:!0}},b={name:`Plain text (no links)`,args:{text:`This is just regular text with no links, emails, or patterns to match.`,hasBuiltins:!0,hasTaskPattern:!1,hasDiffPattern:!1}},x={name:`Builtins disabled (custom only)`,args:{text:`T123 is a task. https://example.com is a URL that should NOT become a link.`,hasBuiltins:!1,hasTaskPattern:!0,hasDiffPattern:!1}},S={render:()=>{let[e,t]=(0,p.useState)(`Check T12345, visit https://react.dev, or email hi@example.com`),n=u(e,{patterns:[{pattern:/\bT(\d+)\b/g,href:e=>`https://tasks.example.com/${e[1]}`,isExternal:!0},{pattern:/\bD(\d+)\b/g,href:e=>`https://phabricator.example.com/${e[0]}`,isExternal:!0}]});return(0,m.jsxs)(a,{gap:4,children:[(0,m.jsx)(c,{label:`Enter text to linkify`,value:e,onChange:e=>t(e)}),(0,m.jsx)(`div`,{style:{padding:16,borderRadius:8,background:`var(--color-background-muted, #f5f5f5)`,minHeight:40},children:(0,m.jsx)(i,{type:`body`,children:n})})]})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {
