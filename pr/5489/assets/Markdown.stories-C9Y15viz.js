...
`),P={args:{children:an}},F={args:{children:an,density:`compact`}},I={name:`AI Response`,args:{children:on,density:`compact`,headingLevelStart:3}},L={name:`Shifted Headings (start at h3)`,args:{children:an,headingLevelStart:3}},R={name:`Inline Display`,render:()=>(0,j.jsxs)(`div`,{style:{maxWidth:680,display:`grid`,gap:16},children:[(0,j.jsx)(i,{type:`large`,display:`block`,children:(0,j.jsx)(d,{display:`inline`,children:"Use `value` with **controlled state** and [read the docs](https://example.com) without creating block wrappers."})}),(0,j.jsxs)(`div`,{style:{border:`1px solid #ddd`,borderRadius:8,padding:12,display:`grid`,gap:6},children:[(0,j.jsx)(i,{type:`body`,weight:`bold`,display:`block`,children:`Prop description`}),(0,j.jsx)(i,{type:`body`,color:`secondary`,display:`block`,children:(0,j.jsx)(d,{display:`inline`,children:'Accepts an action item `{label, onClick?, icon?}`, a divider `{type: "divider"}`, or a section `{type: "section", items: [...]}`.'})})]})]})},z={name:`Table`,args:{children:[`## Comparison Table`,``,`| Feature | React | Vue | Svelte |`,`|:--------|:-----:|:---:|-------:|`,`| Virtual DOM | Yes | Yes | No |`,`| Bundle Size | ~40KB | ~30KB | ~2KB |`,`| TypeScript | Native | Plugin | Native |`,`| Learning Curve | Medium | Easy | Easy |`].join(`
`)}},B={render:()=>{let e=on,[t,n]=(0,A.useState)(0),[r,i]=(0,A.useState)(!0),[o,s]=(0,A.useState)(0);return(0,A.useEffect)(()=>{if(!r)return;if(t>=e.length){i(!1);return}let a=Math.floor(Math.random()*8)+2,o=30+Math.random()*60,s=setTimeout(()=>{n(t=>Math.min(t+a,e.length))},o);return()=>clearTimeout(s)},[t,r,e]),(0,j.jsxs)(`div`,{children:[(0,j.jsxs)(`div`,{style:{marginBlockEnd:12,display:`flex`,gap:8,alignItems:`center`},children:[(0,j.jsx)(a,{label:`Replay`,variant:`secondary`,size:`sm`,onClick:(0,A.useCallback)(()=>{n(0),i(!0),s(e=>e+1)},[]),isDisabled:r}),(0,j.jsx)(`span`,{style:{fontSize:12,color:`var(--color-text-secondary)`},children:r?`Streaming... ${t}/${e.length}`:`Complete`})]}),(0,j.jsx)(d,{isStreaming:r,density:`compact`,headingLevelStart:3,children:e.slice(0,t)},o)]})}},V={name:`With Images`,render:()=>(0,j.jsx)(`div`,{style:{maxWidth:800},children:(0,j.jsx)(d,{children:`
