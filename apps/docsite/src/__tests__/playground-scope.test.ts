 ...
 * @input Generated scope text and the core package export manifest.
 * @output Checks for complete component coverage and valid TypeScript syntax.
 * @position Regression coverage for the playground scope generator.
 *
...
describe('playground-scope', () => {
  ...
  it('generates valid TypeScript with nested supporting-module exports', () => {
    const {diagnostics} = transpileModule(scopeContent, {
      compilerOptions: {target: ScriptTarget.ESNext},
      reportDiagnostics: true,
    });
    expect(diagnostics).toEqual([]);
    expect(scopeContent).not.toContain(
      "from '@astryxdesign/core/Dialog/DialogContext'",
    );
  });
