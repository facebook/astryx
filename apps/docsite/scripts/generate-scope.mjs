...
/**
 * Generates apps/docsite/src/app/(preview)/playground-preview/scope.ts
 *
...
const OUT = resolve(ROOT, 'src/app/(preview)/playground-preview/scope.ts');
...
// @xds/lab — experimental components (charts, etc.) used by page templates.
// Single-barrel package, so a namespace import covers every export.
lines.push("import * as XDSLab from '@xds/lab';");
lines.push('');
...
// @xds/lab — experimental components (charts) for template code.
lines.push("  '@xds/lab': XDSLab,");
...
console.log('  @xds/lab (experimental components)');
