 ...
 * @input Core package exports and explicit playground support modules.
 * @output TypeScript imports and scope entries for top-level components.
 * @position Docsite generation; nested support modules are not components.
 *
...
// Read core package.json exports and extract top-level PascalCase subpaths.
// Nested supporting modules cannot serve as component namespace identifiers.
