...
`;
  ...
  // Slugs only, in their own module: the autolinker for `astryx docs <topic>`
  // references runs in client components, and importing docsRegistry there
  // would pull every doc's full section content into the browser bundle.
  writeRegistry(
    'docTopicSlugs.ts',
    `// Auto-generated by scripts/generate-data.mjs — do not edit

/** Every slug served by /docs/[topic], derived from the CLI's doc topics. */
export const docTopicSlugs: readonly string[] = ${JSON.stringify(
