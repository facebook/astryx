...
import {
  ...
  furnitureReviews,
  furnitureCartItems,
  furnitureCartSummary,
  furnitureStoreSummary,
  formatPrice,
  type Product,
  type Order,
  type Customer,
...
const meta: Meta = {
  title: 'Examples/Furniture Store',
  tags: ['autodocs'],
  decorators: [
    Story => (
...
export const Dashboard: Story = {
  render: () => {
    const stats = [
      {
        label: 'Total Revenue',
        value: formatPrice(furnitureStoreSummary.totalRevenue),
      },
      {label: 'Orders', value: furnitureStoreSummary.totalOrders.toString()},
      {
        label: 'Customers',
        value: furnitureStoreSummary.totalCustomers.toString(),
      },
      {
        label: 'Avg Order Value',
        value: formatPrice(furnitureStoreSummary.averageOrderValue),
      },
    ];

    const maxRevenue = Math.max(
      ...furnitureStoreSummary.topCategories.map(c => c.revenue),
    );
      ...
      <XDSVStack gap="space6">
        ...
        <XDSCard>
          <XDSVStack gap="space4">
            ...
            {furnitureStoreSummary.revenueByMonth.map(({month, revenue}) => (
        ...
        <XDSCard>
          <XDSVStack gap="space4">
            ...
            {furnitureStoreSummary.topCategories.map(cat => (
        ...
        <XDSCard>
          <XDSVStack gap="space4">
            ...
            <XDSTable
              data={furnitureOrders.slice(0, 5)}
              columns={furnitureOrderColumns}
              idKey="id"
              hasHover
              density="balanced"
            />
...
const furnitureOrderColumns: XDSTableColumn<Order>[] = [
      ...
      <XDSHStack gap="space2" vAlign="center" hAlign="between">
        ...
        <XDSHStack gap="space2">
          <XDSBadge variant="neutral">
            {furnitureProducts.length} pieces
          </XDSBadge>
    ...
    return (
      <XDSVStack gap="space4">
        <XDSHStack gap="space2" vAlign="center" hAlign="between">
          ...
          <XDSBadge variant="neutral">{furnitureOrders.length} orders</XDSBadge>
        </XDSHStack>
        <XDSCard>
          <XDSTable
            data={furnitureOrders}
    ...
    return (
      <XDSVStack gap="space4">
        <XDSHStack gap="space2" vAlign="center" hAlign="between">
          ...
          <XDSBadge variant="neutral">
            {furnitureCustomers.length} customers
          </XDSBadge>
        </XDSHStack>
        <XDSCard>
          <XDSTable
            data={furnitureCustomers}
          ...
          <XDSVStack gap="space4">
            <XDSHStack gap="space2" vAlign="center" hAlign="between">
              <p {...stylex.props(styles.sectionTitle)}>
                Cart ({furnitureCartSummary.itemCount} items)
              </p>
            ...
            {furnitureCartItems.map((item, i) => (
              <div key={item.id}>
                ...
                {i < furnitureCartItems.length - 1 && <XDSDivider />}
              </div>
            ))}
          </XDSVStack>
        </XDSCard>
          ...
          <XDSVStack gap="space4">
            ...
            <div {...stylex.props(styles.summaryRow)}>
              ...
              <p {...stylex.props(styles.summaryValue)}>
                {formatPrice(furnitureCartSummary.subtotal)}
              </p>
            </div>
            <div {...stylex.props(styles.summaryRow)}>
              <p {...stylex.props(styles.summaryLabel)}>Shipping</p>
              <p {...stylex.props(styles.summaryValue)}>
                {furnitureCartSummary.shipping === 0
                  ? 'Free'
                  : formatPrice(furnitureCartSummary.shipping)}
              </p>
            </div>
            <div {...stylex.props(styles.summaryRow)}>
              <p {...stylex.props(styles.summaryLabel)}>Tax</p>
              <p {...stylex.props(styles.summaryValue)}>
                {formatPrice(furnitureCartSummary.tax)}
              </p>
            </div>
            <XDSDivider />
            <div {...stylex.props(styles.summaryRow)}>
              ...
              <p {...stylex.props(styles.summaryTotal)}>
                {formatPrice(furnitureCartSummary.total)}
              </p>
            </div>
