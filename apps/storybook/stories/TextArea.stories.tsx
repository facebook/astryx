...
const meta: Meta<typeof TextArea> = {
  ...
  argTypes: {
    ...
    isReadOnly: {
      control: 'boolean',
      description:
        'Whether the textarea is read-only. The value still submits with the form but cannot be edited. Unlike isDisabled it is not dimmed and stays in the tab order.',
    },
    disabledMessage: {
      control: 'text',
      description:
...
export const ReadOnly: Story = {
  render: args => {
    const [value, setValue] = useState(
      args.value ??
        'Generated by the importer; edit the source file to change it.',
    );
    return <TextArea {...args} value={value} onChange={setValue} />;
  },
  args: {
