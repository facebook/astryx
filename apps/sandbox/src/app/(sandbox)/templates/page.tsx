...
const rows: TemplateRow[] = [
  ...templates.map(t => ({
    ...
    type: 'Page' as const,
    component: 'n/a',
    codePath: `packages/core/templates/pages/${t.slug}/page.tsx`,
    docPath: `packages/core/templates/pages/${t.slug}/template.doc.mjs`,
    isReady: t.isReady,
    isShowcase: false,
  })),
  ...blocks.map(b => ({
    ...
    codePath: `packages/core/templates/blocks/components/${b.component}/${b.slug}.tsx`,
    docPath: `packages/core/templates/blocks/components/${b.component}/${b.slug}.doc.mjs`,
    isReady: b.isReady,
