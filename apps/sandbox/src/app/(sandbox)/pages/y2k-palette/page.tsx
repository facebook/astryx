...
function tonalPalette(
  ...
  for (const t of TONE_STEPS) {
    ...
    result[t] = hctToHex({hue, chroma: Math.min(chroma * boost, maxChroma), tone: t});
  }
  return result;
}
...
const CARD_VARIANTS = ['default', 'muted', 'blue', 'cyan', 'gray', 'green', 'orange', 'pink', 'purple', 'red', 'teal', 'yellow'] as const;
