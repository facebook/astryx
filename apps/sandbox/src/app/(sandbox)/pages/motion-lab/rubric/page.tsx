  ...
  return (
    <LabPage
      ...
      <Banner
        ...
        endContent={
          <Link href="/pages/motion-lab/published/">The conflicts</Link>
        }
      />
        ...
        <DemoCard
          ...
          <DemoBody>
            ...
            <Text type="supporting" color="secondary">
              ...
              <Link href="/pages/motion-lab/bugs/">
                the bugs page has the whole list
              </Link>
        ...
        <DemoCard
          ...
          <DemoBody>
            ...
            <Text type="supporting" color="secondary">
              ...
              <Link href="/pages/motion-lab/reduced-motion/">
