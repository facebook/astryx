  ...
  return (
    <LabPage
      ...
      <VStack gap={3}>
        ...
        <Text type="supporting" color="secondary">
          The rule stub is on <Link href="/motion/export">Export tuning</Link>.
          The reduced-motion decision that blocks family one is on{' '}
          <Link href="/motion/reduced-motion">Reduced motion</Link>.
        </Text>
      </VStack>
    </LabPage>
  );
